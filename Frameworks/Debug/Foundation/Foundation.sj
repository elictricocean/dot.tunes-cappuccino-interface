...
p;14;CPDictionary.ji;10;CPObject.ji;14;CPEnumerator.ji;13;CPException.jc;7703;
...
p;19;CPKeyedUnarchiver.ji;8;CPNull.ji;9;CPCoder.jc;12382;
...
p;7;CPSet.ji;10;CPObject.ji;9;CPArray.ji;10;CPNumber.ji;14;CPEnumerator.jc;8649;
...
}), new objj_method(sel_getUid("initWithArray:"), function $CPSet__initWithArray_(self, _cmd, array)
{ with(self)
{
...
}), new objj_method(sel_getUid("initWithSet:"), function $CPSet__initWithSet_(self, _cmd, set)
{ with(self)
{
    return objj_msgSend(set, "copy");
}
}), new objj_method(sel_getUid("initWithSet:copyItems:"), function $CPSet__initWithSet_copyItems_(self, _cmd, set, flag)
{ with(self)
{
    return objj_msgSend(self, "initWithSet:", set);
}
...
p;10;CPString.ji;10;CPObject.ji;13;CPException.ji;18;CPSortDescriptor.jc;11541;
