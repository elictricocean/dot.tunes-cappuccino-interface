@STATIC;1.0;p;31;_CPBorderlessBridgeWindowView.ji;15;_CPWindowView.jc;2475;
...
{ with(self)
{
    ...
    var owningWindow = objj_msgSend(self, "owningWindow"),
        bounds = objj_msgSend(self, "bounds");
    objj_msgSend(objj_msgSend(owningWindow, "contentView"), "setFrame:", CGRectMake(0.0, objj_msgSend(self, "toolbarMaxY"), CGRectGetWidth(bounds), CGRectGetHeight(bounds) - objj_msgSend(self, "toolbarMaxY")));
    if (!objj_msgSend(objj_msgSend(owningWindow, "toolbar"), "isVisible"))
    {
...
p;17;_CPCibConnector.jI;21;Foundation/CPObject.jI;29;Foundation/CPKeyValueCoding.jc;4581;
...
p;20;_CPCibCustomObject.jI;21;Foundation/CPObject.jc;1838;
...
p;18;_CPCibCustomView.ji;8;CPView.jc;2809;
...
p;18;_CPHUDWindowView.jc;8708;var _CPHUDWindowViewBackgroundColor = nil,
...
{ with(self)
{
    ...
    if (objj_msgSend(objj_msgSend(objj_msgSend(self, "owningWindow"), "toolbar"), "isVisible"))
    {
...
}), new objj_method(sel_getUid("initWithFrame:styleMask:owningWindow:"), function $_CPHUDWindowView__initWithFrame_styleMask_owningWindow_(self, _cmd, aFrame, aStyleMask, aWindow)
{ with(self)
{
    self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("_CPWindowView") }, "initWithFrame:styleMask:owningWindow:", aFrame, aStyleMask, aWindow);
    if (self)
    {
        ...
        if (_styleMask & CPClosableWindowMask)
        {
            ...
            objj_msgSend(_closeButton, "setTarget:", aWindow);
...
{ with(self)
{
    objj_msgSendSuper({ receiver:self, super_class:objj_getClass("_CPWindowView") }, "tile");
    var owningWindow = objj_msgSend(self, "owningWindow");
    objj_msgSend(objj_msgSend(owningWindow, "contentView"), "setFrameOrigin:", CGPointMake(0.0, objj_msgSend(self, "toolbarMaxY")));
}
})]);
...
p;22;_CPImageAndTitleView.jI;21;Foundation/CPString.ji;9;CPColor.ji;8;CPFont.ji;9;CPImage.ji;13;CPTextField.ji;8;CPView.jc;8830;
{var the_class = objj_allocateClassPair(CPView, "_CPImageAndTitleView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_alignment"), new objj_ivar("_textColor"), new objj_ivar("_font"), new objj_ivar("_imagePosition"), new objj_ivar("_imageScaling"), new objj_ivar("_image"), new objj_ivar("_title"), new objj_ivar("_titleSize"), new objj_ivar("_titleField")]);
objj_registerClassPair(the_class);
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
...
p;23;_CPStandardWindowView.ji;15;_CPWindowView.jc;12011;
...
}), new objj_method(sel_getUid("initWithFrame:styleMask:owningWindow:"), function $_CPStandardWindowView__initWithFrame_styleMask_owningWindow_(self, _cmd, aFrame, aStyleMask, aWindow)
{ with(self)
{
    self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("_CPWindowView") }, "initWithFrame:styleMask:owningWindow:", aFrame, aStyleMask, aWindow);
    if (self)
    {
        var theClass = objj_msgSend(self, "class"),
            bounds = objj_msgSend(self, "bounds");
        _headView = objj_msgSend(objj_msgSend(_CPTexturedWindowHeadView, "alloc"), "initWithFrame:", CGRectMake(0.0, 0.0, CGRectGetWidth(bounds), STANDARD_TITLEBAR_HEIGHT));
        ...
        objj_msgSend(self, "setShowsResizeIndicator:", NO);
        objj_msgSend(self, "setShowsResizeIndicator:", YES);
        _titleField = objj_msgSend(objj_msgSend(CPTextField, "alloc"), "initWithFrame:", CGRectMakeZero());
...
{ with(self)
{
    ...
    objj_msgSend(_dividerView, "setFrameOrigin:", CGPointMake(0.0, CGRectGetMaxY(objj_msgSend(_headView, "frame"))));
    objj_msgSend(_bodyView, "setFrameOrigin:", CGPointMake(0.0, CGRectGetMaxY(objj_msgSend(_dividerView, "frame"))));
    objj_msgSend(_titleField, "setFrame:", CGRectMake(10.0, 0.0, width - 20.0, CGRectGetHeight(objj_msgSend(_titleField, "frame"))));
    objj_msgSend(objj_msgSend(owningWindow, "contentView"), "setFrameOrigin:", CGPointMake(0.0, CGRectGetMaxY(objj_msgSend(_dividerView, "frame"))));
}
...
p;15;_CPWindowView.ji;8;CPView.ji;13;CPImageView.jc;11318;
var _CPWindowViewResizeIndicatorImage = nil;
{var the_class = objj_allocateClassPair(CPView, "_CPWindowView"),
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_styleMask"), new objj_ivar("_resizeIndicator"), new objj_ivar("_resizeIndicatorOffset"), new objj_ivar("_toolbarView"), new objj_ivar("_owningWindow"), new objj_ivar("_resizeFrame"), new objj_ivar("_mouseDraggedPoint")]);
objj_registerClassPair(the_class);
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
...
}), new objj_method(sel_getUid("initWithFrame:styleMask:owningWindow:"), function $_CPWindowView__initWithFrame_styleMask_owningWindow_(self, _cmd, aFrame, aStyleMask, aWindow)
{ with(self)
{
    self = objj_msgSendSuper({ receiver:self, super_class:objj_getClass("CPView") }, "initWithFrame:", aFrame);
    if (self)
...
}), new objj_method(sel_getUid("owningWindow"), function $_CPWindowView__owningWindow(self, _cmd)
{ with(self)
{
...
{ with(self)
{
    var theWindow = objj_msgSend(self, "owningWindow");
...
{ with(self)
{
    ...
    if (type === CPLeftMouseUp)
        ...
        _mouseDraggedPoint = objj_msgSend(objj_msgSend(self, "owningWindow"), "convertBaseToBridge:", objj_msgSend(anEvent, "locationInWindow"));
    else if (type === CPLeftMouseDragged)
    {
        var theWindow = objj_msgSend(self, "owningWindow"),
...
{ with(self)
{
    ...
    if (objj_msgSend(objj_msgSend(owningWindow, "toolbar"), "isVisible"))
    {
        ...
        objj_msgSend(toolbarView, "setFrameOrigin:", CGPointMake(toolbarOffset.width, toolbarOffset.height));
    }
...
{
    var owningWindow = objj_msgSend(self, "owningWindow"),
        toolbar = objj_msgSend(owningWindow, "toolbar"),
    ...
    if (_toolbarView !== toolbarView)
    {
        ...
        if (toolbarView)
        {
            ...
            objj_msgSend(toolbarView, "setFrameSize:", CGSizeMake(CGRectGetWidth(objj_msgSend(self, "bounds")), CGRectGetHeight(objj_msgSend(toolbarView, "frame"))));
    ...
    objj_msgSend(owningWindow, "setFrameSize:", objj_msgSend(self, "frameRectForContentRect:", objj_msgSend(objj_msgSend(owningWindow, "contentView"), "frame")).size);
...
p;13;CPAnimation.jI;21;Foundation/CPObject.ji;23;CAMediaTimingFunction.jc;5807;
...
p;15;CPApplication.jI;21;Foundation/CPBundle.ji;17;CPCompatibility.ji;9;CPEvent.ji;8;CPMenu.ji;13;CPResponder.ji;22;CPDocumentController.jc;19860;
CPApp = nil;
...
p;7;CPCib.jI;21;Foundation/CPObject.jI;28;Foundation/CPURLConnection.jI;25;Foundation/CPURLRequest.ji;20;_CPCibCustomObject.ji;18;_CPCibCustomView.ji;23;_CPCibKeyedUnarchiver.ji;18;_CPCibObjectData.ji;22;_CPCibWindowTemplate.jc;2314;
...
{ with(self)
{
    ...
    if (topLevelObjects)
        objj_msgSend(topLevelObjects, "addObjectsFromArray:", objj_msgSend(objectData, "topLevelObjects"));
}
...
p;18;CPCollectionView.jI;20;Foundation/CPArray.jI;19;Foundation/CPData.jI;23;Foundation/CPIndexSet.jI;28;Foundation/CPKeyedArchiver.jI;30;Foundation/CPKeyedUnarchiver.jI;15;AppKit/CPView.jc;16083;
...
p;9;CPColor.jI;21;Foundation/CPObject.ji;9;CGColor.ji;17;CPCompatibility.ji;9;CPImage.jc;16280;
var _redComponent = 0,
    _greenComponent = 1,
    _blueComponent = 2,
    _alphaCompnent = 3;
...
p;14;CPColorPanel.ji;10;CPButton.ji;10;CPCookie.ji;9;CPPanel.ji;8;CPView.jc;20163;
...
p;11;CPControl.ji;8;CPFont.ji;10;CPShadow.ji;8;CPView.jc;18490;
...
p;19;CPDOMWindowBridge.jI;21;Foundation/CPObject.jI;22;Foundation/CPRunLoop.ji;9;CPEvent.ji;17;CPCompatibility.ji;18;CPDOMWindowLayer.jc;30687;
...
p;14;CPDragServer.jI;15;AppKit/CPView.jI;16;AppKit/CPEvent.jI;21;AppKit/CPPasteboard.jI;20;AppKit/CPImageView.jc;11607;
...
{ with(self)
{
    return objj_msgSend(objj_msgSend(CPDragServerDestination, "window"), "convertBridgeToBase:", objj_msgSend(CPDragServerView, "frame").origin);
}
...
p;13;CPImageView.jI;33;Foundation/CPNotificationCenter.ji;11;CPControl.ji;9;CPImage.ji;14;CPShadowView.jc;9719;
CPScaleProportionally = 0;
CPScaleToFit = 1;
CPScaleNone = 2;
...
p;8;CPMenu.jI;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jI;33;Foundation/CPNotificationCenter.jI;21;Foundation/CPString.ji;15;CPApplication.ji;12;CPClipView.ji;12;CPMenuItem.ji;9;CPPanel.jc;58952;
...
p;15;CPPopUpButton.ji;10;CPButton.ji;12;CPGeometry.ji;8;CPMenu.ji;12;CPMenuItem.jc;18398;
...
{ with(self)
{
    ...
    else
    {
        ...
        menuOrigin.x -= CGRectGetMinX(contentRect) + objj_msgSend(objj_msgSend(objj_msgSend(menu, "itemAtIndex:", _selectedIndex), "_menuItemView"), "calculatedLeftMargin");
...
p;19;CPSecureTextField.ji;13;CPTextField.jc;1215;
...
p;20;CPSegmentedControl.jI;20;Foundation/CPArray.ji;11;CPControl.jc;21727;
...
p;13;CPSplitView.ji;9;CPImage.ji;8;CPView.jc;20938;
...
p;15;CPTabViewItem.jI;21;Foundation/CPObject.jI;15;AppKit/CPView.jc;3722;
CPSelectedTab = 0;
CPBackgroundTab = 1;
CPPressedTab = 2;
...
p;13;CPTextField.ji;11;CPControl.ji;17;CPStringDrawing.jc;16381;
...
p;11;CPToolbar.jI;21;Foundation/CPObject.ji;15;CPPopUpButton.ji;15;CPToolbarItem.jc;24273;
...
meta_class = the_class.isa;class_addIvars(the_class, [new objj_ivar("_toolbar"), new objj_ivar("_flexibleWidthIndexes"), new objj_ivar("_visibleFlexibleWidthIndexes"), new objj_ivar("_itemInfos"), new objj_ivar("_visibleItems"), new objj_ivar("_invisibleItems"), new objj_ivar("_additionalItemsButton"), new objj_ivar("_labelColor")]);
objj_registerClassPair(the_class);
objj_addClassForBundle(the_class, objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
...
p;15;CPToolbarItem.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.jI;16;AppKit/CPImage.jI;15;AppKit/CPView.jc;13108;
...
p;8;CPView.jI;20;Foundation/CPArray.jI;26;Foundation/CPObjJRuntime.ji;19;CGAffineTransform.ji;12;CGGeometry.ji;9;CPColor.ji;20;CPDOMDisplayServer.ji;12;CPGeometry.ji;13;CPResponder.ji;19;CPGraphicsContext.jc;39475;
CPViewNotSizable = 0;
CPViewMinXMargin = 1;
...
p;10;CPWindow.jI;33;Foundation/CPNotificationCenter.jI;26;Foundation/CPUndoManager.ji;12;CGGeometry.ji;13;CPAnimation.ji;13;CPResponder.jc;41371;
...
{ with(self)
{
    ...
    if (self)
    {
        ...
        _windowView = objj_msgSend(objj_msgSend(windowViewClass, "alloc"), "initWithFrame:styleMask:owningWindow:", CGRectMake(0.0, 0.0, CGRectGetWidth(_frame), CGRectGetHeight(_frame)), aStyleMask, self);
        ...
        objj_msgSend(self, "setNextResponder:", CPApp);
        objj_msgSend(self, "setHasShadow:", aStyleMask !== CPBorderlessWindowMask && !(aStyleMask & CPBorderlessBridgeWindowMask));
    }
    return self;
}
...
i;15;_CPWindowView.ji;23;_CPStandardWindowView.ji;18;_CPHUDWindowView.ji;25;_CPBorderlessWindowView.ji;31;_CPBorderlessBridgeWindowView.ji;14;CPDragServer.ji;19;CPDOMWindowBridge.ji;8;CPView.jp;20;CPWindowController.jI;21;Foundation/CPObject.jI;21;Foundation/CPString.ji;13;CPResponder.ji;10;CPWindow.ji;12;CPDocument.jc;6333;
