...
p;18;_CPCibCustomView.ji;8;CPView.jc;2054;
...
p;22;_CPImageAndTitleView.jI;21;Foundation/CPString.ji;9;CPColor.ji;8;CPFont.ji;9;CPImage.ji;13;CPTextField.ji;8;CPView.jc;5883;
var _1=objj_allocateClassPair(CPView,"_CPImageAndTitleView"),_2=_1.isa;
class_addIvars(_1,[new objj_ivar("_alignment"),new objj_ivar("_textColor"),new objj_ivar("_font"),new objj_ivar("_imagePosition"),new objj_ivar("_imageScaling"),new objj_ivar("_image"),new objj_ivar("_title"),new objj_ivar("_titleSize"),new objj_ivar("_titleField")]);
objj_registerClassPair(_1);
objj_addClassForBundle(_1,objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
...
with(_3e){
var _40=CGSizeMakeZero();
if(_imagePosition!=CPNoImage&&_image){
var _41=objj_msgSend(_image,"size");
_40.width+=_41.width;
...
_40.width+=_titleSize.width;
_40.height=MAX(_40.height,_titleSize.height);
}else{
if(_imagePosition==CPImageAbove||_imagePosition==CPImageBelow){
_40.width=MAX(_40.width,_titleSize.width);
_40.height+=_titleSize.height;
}else{
_40.width=MAX(_40.width,_titleSize.width);
_40.height=MAX(_40.height,_titleSize.height);
}
...
objj_msgSend(_3e,"setFrameSize:",_40);
}
}),new objj_method(sel_getUid("resizeSubviewsWithOldSize:"),function(_42,_43,_44){
with(_42){
...
p;13;CPAnimation.jI;21;Foundation/CPObject.ji;23;CAMediaTimingFunction.jc;4164;
...
p;7;CPCib.jI;21;Foundation/CPObject.jI;28;Foundation/CPURLConnection.jI;25;Foundation/CPURLRequest.ji;20;_CPCibCustomObject.ji;18;_CPCibCustomView.ji;23;_CPCibKeyedUnarchiver.ji;18;_CPCibObjectData.ji;22;_CPCibWindowTemplate.jc;1659;
...
if(_d){
objj_msgSend(_d,"addObjectsFromArray:",objj_msgSend(_b,"topLevelObjects"));
}
}
...
p;18;CPCollectionView.jI;20;Foundation/CPArray.jI;19;Foundation/CPData.jI;23;Foundation/CPIndexSet.jI;28;Foundation/CPKeyedArchiver.jI;30;Foundation/CPKeyedUnarchiver.jI;15;AppKit/CPView.jc;11731;
...
objj_msgSend(_60,"setAlphaValue:",0.7);
...
p;11;CPControl.ji;8;CPFont.ji;10;CPShadow.ji;8;CPView.jc;13428;
...
p;19;CPDOMWindowBridge.jI;21;Foundation/CPObject.jI;22;Foundation/CPRunLoop.ji;9;CPEvent.ji;17;CPCompatibility.ji;18;CPDOMWindowLayer.jc;17744;
...
var x=0,y=0,_89=_86.target;
while(_89.nodeType!==1){
_89=_89.parentNode;
}
if(_89.offsetParent){
do{
x+=_89.offsetLeft;
y+=_89.offsetTop;
}while(_89=_89.offsetParent);
}
var _8a={x:(x+((_86.clientX-8)/15)),y:(y+((_86.clientY-8)/15))};
}else{
var _8a={x:_86.clientX,y:_86.clientY};
}
var _8b=0,_8c=0,_8d=0,_8e=_86.timeStamp?_86.timeStamp:new Date(),_8f=(_86.shiftKey?CPShiftKeyMask:0)|(_86.ctrlKey?CPControlKeyMask:0)|(_86.altKey?CPAlternateKeyMask:0)|(_86.metaKey?CPCommandKeyMask:0);
StopDOMEventPropagation=YES;
_8d=objj_msgSend(objj_msgSend(_84,"hitTest:",_8a),"windowNumber");
if(!_8d){
return;
}
var _90=CPApp._windows[_8d]._frame;
_8a.x-=CGRectGetMinX(_90);
_8a.y-=CGRectGetMinY(_90);
if(typeof _86.wheelDeltaX!="undefined"){
_8b=_86.wheelDeltaX/120;
_8c=_86.wheelDeltaY/120;
}else{
if(_86.wheelDelta){
_8c=_86.wheelDelta/120;
}else{
if(_86.detail){
_8c=-_86.detail/3;
}else{
...
var _91=objj_msgSend(CPEvent,"mouseEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:clickCount:pressure:",CPScrollWheel,_8a,_8f,_8e,_8d,nil,-1,1,0);
_91._DOMEvent=_86;
_91._deltaX=ROUND(_8b*1.5);
_91._deltaY=ROUND(_8c*1.5);
...
}),new objj_method(sel_getUid("_bridgeResizeEvent:"),function(_92,_93,_94){
with(_92){
try{
var _95=_frame.size;
_frame=_2(_DOMWindow);
...
while(_9a--){
objj_msgSend(_99[_9a],"resizeWithOldBridgeSize:",_95);
}
}
objj_msgSend(objj_msgSend(CPRunLoop,"currentRunLoop"),"limitDateForMode:",CPDefaultRunLoopMode);
}
...
}),new objj_method(sel_getUid("_checkPasteboardElement"),function(_9b,_9c){
with(_9b){
try{
var _9d=_DOMPasteboardElement.value;
if(objj_msgSend(_9d,"length")){
var _9e=objj_msgSend(CPPasteboard,"generalPasteboard");
if(objj_msgSend(_9e,"_stateUID")!=_9d){
objj_msgSend(_9e,"declareTypes:owner:",[CPStringPboardType],_9b);
objj_msgSend(_9e,"setString:forType:",_9d,CPStringPboardType);
}
}
objj_msgSend(_9b,"_clearPasteboardElement");
...
}),new objj_method(sel_getUid("_clearPasteboardElement"),function(_9f,_a0){
with(_9f){
_DOMPasteboardElement.value="";
_DOMPasteboardElement.blur();
}
})]);
var _a1=5,_a2=(typeof document!="undefined"&&document.addEventListener)?350:1000;
var _3=function(_a3,_a4,_a5){
if(!_a3){
return 1;
}
var _a6=objj_msgSend(_a3,"locationInWindow");
return (_a4-objj_msgSend(_a3,"timestamp")<_a2&&ABS(_a6.x-_a5.x)<_a1&&ABS(_a6.y-_a5.y)<_a1)?objj_msgSend(_a3,"clickCount")+1:1;
};
var _4=function(_a7){
_a7.cancelBubble=true;
_a7.returnValue=false;
if(_a7.preventDefault){
_a7.preventDefault();
}
if(_a7.stopPropagation){
_a7.stopPropagation();
}
if(_a7.type==CPDOMEventMouseDown){
...
p;14;CPDragServer.jI;15;AppKit/CPView.jI;16;AppKit/CPEvent.jI;21;AppKit/CPPasteboard.jI;20;AppKit/CPImageView.jc;6648;
var _1=nil;
...
}),new objj_method(sel_getUid("draggedView"),function(_23,_24){
with(_23){
return _2;
}
})]);
...
objj_registerClassPair(_16);
objj_addClassForBundle(_16,objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
class_addMethods(_16,[new objj_method(sel_getUid("init"),function(_25,_26){
with(_25){
...
}),new objj_method(sel_getUid("dragView:fromWindow:at:offset:event:pasteboard:source:slideBack:"),function(_27,_28,_29,_2a,_2b,_2c,_2d,_2e,_2f,_30){
with(_27){
var _31=objj_msgSend(_2d,"locationInWindow");
_2=_29;
_3=_2f;
_4=_2a;
_5=CPPointMake(_31.x-_2b.x,_31.y-_2b.y);
...
objj_msgSend(_dragWindow,"orderFront:",_27);
objj_msgSend(_29,"setFrameOrigin:",_2b);
objj_msgSend(objj_msgSend(_dragWindow,"contentView"),"addSubview:",_29);
if(_a){
if(objj_msgSend(_3,"respondsToSelector:",sel_getUid("draggedImage:beganAt:"))){
objj_msgSend(_3,"draggedImage:beganAt:",objj_msgSend(_29,"image"),_2b);
}
...
objj_msgSend(_3,"draggedView:beganAt:",_29,_2b);
}
...
}),new objj_method(sel_getUid("dragImage:fromWindow:at:offset:event:pasteboard:source:slideBack:"),function(_32,_33,_34,_35,_36,_37,_38,_39,_3a,_3b){
with(_32){
_a=YES;
if(!_imageView){
_imageView=objj_msgSend(objj_msgSend(CPImageView,"alloc"),"initWithFrame:",CPRectMakeZero());
}
objj_msgSend(_imageView,"setImage:",_34);
objj_msgSend(_imageView,"setFrameSize:",CGSizeMakeCopy(objj_msgSend(_34,"size")));
objj_msgSend(_32,"dragView:fromWindow:at:offset:event:pasteboard:source:slideBack:",_imageView,_35,_36,_37,_38,_39,_3a,_3b);
}
})]);
class_addMethods(_17,[new objj_method(sel_getUid("initialize"),function(_3c,_3d){
with(_3c){
if(_3c!=objj_msgSend(CPDragServer,"class")){
return;
}
_9=objj_msgSend(objj_msgSend(CPDraggingInfo,"alloc"),"init");
}
}),new objj_method(sel_getUid("sharedDragServer"),function(_3e,_3f){
with(_3e){
if(!_1){
...
var _17=_16.isa;
class_addMethods(_16,[new objj_method(sel_getUid("_dragHitTest:pasteboard:"),function(_40,_41,_42,_43){
with(_40){
if(!CPRectContainsPoint(_frame,_42)||_40==_2){
return nil;
}
var _44=nil,i=objj_msgSend(_subviews,"count"),_46=CPPointMake(_42.x-CPRectGetMinX(_frame),_42.y-CPRectGetMinY(_frame));
while(i--){
if(_44=objj_msgSend(_subviews[i],"_dragHitTest:pasteboard:",_46,_43)){
return _44;
}
}
if(objj_msgSend(_43,"availableTypeFromArray:",_registeredDraggedTypes)){
return _40;
}
return nil;
}
...
p;13;CPImageView.jI;33;Foundation/CPNotificationCenter.ji;11;CPControl.ji;9;CPImage.ji;14;CPShadowView.jc;6670;
CPScaleProportionally=0;
CPScaleToFit=1;
CPScaleNone=2;
var _1=nil;
...
p;8;CPMenu.jI;20;Foundation/CPArray.jI;25;Foundation/CPDictionary.jI;33;Foundation/CPNotificationCenter.jI;21;Foundation/CPString.ji;15;CPApplication.ji;12;CPClipView.ji;12;CPMenuItem.ji;9;CPPanel.jc;42670;
...
}),new objj_method(sel_getUid("setIconImage:"),function(self,_cmd,_156){
with(self){
objj_msgSend(_iconImageView,"setImage:",_156);
objj_msgSend(_iconImageView,"setHidden:",_156==nil);
objj_msgSend(self,"tile");
}
}),new objj_method(sel_getUid("setIconImageAlphaValue:"),function(self,_cmd,_159){
with(self){
objj_msgSend(_iconImageView,"setAlphaValue:",_159);
}
}),new objj_method(sel_getUid("setColor:"),function(self,_cmd,_15c){
with(self){
if(!_15c){
if(!_14b){
...
}),new objj_method(sel_getUid("setTextColor:"),function(self,_cmd,_15f){
with(self){
if(_textColor==_15f){
return;
}
...
}),new objj_method(sel_getUid("setTitleColor:"),function(self,_cmd,_162){
with(self){
if(_titleColor==_162){
return;
}
_titleColor=_162;
objj_msgSend(_titleField,"setTextColor:",_162?_162:objj_msgSend(CPColor,"blackColor"));
}
}),new objj_method(sel_getUid("setMenu:"),function(self,_cmd,_165){
with(self){
if(_menu==_165){
return;
}
var _166=objj_msgSend(CPNotificationCenter,"defaultCenter");
if(_menu){
objj_msgSend(_166,"removeObserver:name:object:",self,CPMenuDidAddItemNotification,_menu);
objj_msgSend(_166,"removeObserver:name:object:",self,CPMenuDidChangeItemNotification,_menu);
objj_msgSend(_166,"removeObserver:name:object:",self,CPMenuDidRemoveItemNotification,_menu);
var _167=objj_msgSend(_menu,"itemArray"),_168=_167.length;
while(_168--){
objj_msgSend(objj_msgSend(_167[_168],"_menuItemView"),"removeFromSuperview");
}
}
_menu=_165;
if(_menu){
objj_msgSend(_166,"addObserver:selector:name:object:",self,sel_getUid("menuDidAddItem:"),CPMenuDidAddItemNotification,_menu);
objj_msgSend(_166,"addObserver:selector:name:object:",self,sel_getUid("menuDidChangeItem:"),CPMenuDidChangeItemNotification,_menu);
objj_msgSend(_166,"addObserver:selector:name:object:",self,sel_getUid("menuDidRemoveItem:"),CPMenuDidRemoveItemNotification,_menu);
}
_menuItemViews=[];
var _169=objj_msgSend(self,"contentView"),_167=objj_msgSend(_menu,"itemArray"),_168=_167.length;
for(index=0;index<_168;++index){
var item=_167[index],_16b=objj_msgSend(item,"_menuItemView");
_menuItemViews.push(_16b);
objj_msgSend(_16b,"setShowsStateColumn:",NO);
objj_msgSend(_16b,"setBelongsToMenuBar:",YES);
objj_msgSend(_16b,"setFont:",_14c);
objj_msgSend(_16b,"setTextColor:",_textColor);
objj_msgSend(_16b,"setHidden:",objj_msgSend(item,"isHidden"));
objj_msgSend(_16b,"synchronizeWithMenuItem");
objj_msgSend(_169,"addSubview:",_16b);
}
objj_msgSend(self,"tile");
}
}),new objj_method(sel_getUid("menuDidChangeItem:"),function(self,_cmd,_16e){
with(self){
var _16f=objj_msgSend(_menu,"itemAtIndex:",objj_msgSend(objj_msgSend(_16e,"userInfo"),"objectForKey:","CPMenuItemIndex")),_170=objj_msgSend(_16f,"_menuItemView");
objj_msgSend(_170,"setHidden:",objj_msgSend(_16f,"isHidden"));
objj_msgSend(_170,"synchronizeWithMenuItem");
objj_msgSend(self,"tile");
}
}),new objj_method(sel_getUid("menuDidAddItem:"),function(self,_cmd,_173){
with(self){
var _174=objj_msgSend(objj_msgSend(_173,"userInfo"),"objectForKey:","CPMenuItemIndex"),_175=objj_msgSend(_menu,"itemAtIndex:",_174),_176=objj_msgSend(_175,"_menuItemView");
objj_msgSend(_menuItemViews,"insertObject:atIndex:",_176,_174);
objj_msgSend(_176,"setShowsStateColumn:",NO);
objj_msgSend(_176,"setBelongsToMenuBar:",YES);
objj_msgSend(_176,"setFont:",_14c);
objj_msgSend(_176,"setTextColor:",_textColor);
objj_msgSend(_176,"setHidden:",objj_msgSend(_175,"isHidden"));
objj_msgSend(_176,"synchronizeWithMenuItem");
objj_msgSend(objj_msgSend(self,"contentView"),"addSubview:",_176);
objj_msgSend(self,"tile");
}
}),new objj_method(sel_getUid("menuDidRemoveItem:"),function(self,_cmd,_179){
with(self){
...
}),new objj_method(sel_getUid("frameForMenuItem:"),function(self,_cmd,_17e){
with(self){
var _17f=objj_msgSend(objj_msgSend(_17e,"_menuItemView"),"frame");
_17f.origin.x-=5;
_17f.origin.y=0;
_17f.size.width+=10;
_17f.size.height=_1;
...
}),new objj_method(sel_getUid("menuItemAtPoint:"),function(self,_cmd,_182){
with(self){
var _183=objj_msgSend(_menu,"itemArray"),_184=_183.length;
while(_184--){
var item=_183[_184];
if(objj_msgSend(item,"isHidden")||objj_msgSend(item,"isSeparatorItem")){
continue;
}
if(CGRectContainsPoint(objj_msgSend(self,"frameForMenuItem:",item),_182)){
return item;
}
}
return nil;
}
}),new objj_method(sel_getUid("mouseDown:"),function(self,_cmd,_188){
with(self){
_trackingMenuItem=objj_msgSend(self,"menuItemAtPoint:",objj_msgSend(_188,"locationInWindow"));
if(!objj_msgSend(_trackingMenuItem,"isEnabled")){
return;
}
if(objj_msgSend(objj_msgSend(_trackingMenuItem,"_menuItemView"),"eventOnSubmenu:",_188)){
return objj_msgSend(self,"showMenu:",_188);
}
if(objj_msgSend(_trackingMenuItem,"isEnabled")){
objj_msgSend(self,"trackEvent:",_188);
}
}
}),new objj_method(sel_getUid("trackEvent:"),function(self,_cmd,_18b){
with(self){
var type=objj_msgSend(_18b,"type");
if(type===CPPeriodic){
return objj_msgSend(self,"showMenu:",_18b);
}
var _18d=objj_msgSend(self,"frameForMenuItem:",_trackingMenuItem),_18e=objj_msgSend(_trackingMenuItem,"_menuItemView"),_18f=CGRectContainsPoint(_18d,objj_msgSend(_18b,"locationInWindow"));
...
objj_msgSend(_18e,"highlight:",_18f);
}else{
if(type==CPLeftMouseDragged){
if(!_18f&&objj_msgSend(_trackingMenuItem,"submenu")){
return objj_msgSend(self,"showMenu:",_18b);
}
objj_msgSend(_18e,"highlight:",_18f);
}else{
objj_msgSend(CPEvent,"stopPeriodicEvents");
objj_msgSend(_18e,"highlight:",NO);
if(_18f){
...
}),new objj_method(sel_getUid("showMenu:"),function(self,_cmd,_192){
with(self){
objj_msgSend(CPEvent,"stopPeriodicEvents");
var _193=objj_msgSend(self,"frameForMenuItem:",_trackingMenuItem),_194=objj_msgSend(_trackingMenuItem,"_menuItemView");
if(!_highlightView){
_highlightView=objj_msgSend(objj_msgSend(CPView,"alloc"),"initWithFrame:",_193);
...
objj_msgSend(_highlightView,"setFrame:",_193);
}
objj_msgSend(objj_msgSend(self,"contentView"),"addSubview:positioned:relativeTo:",_highlightView,CPWindowBelow,_194);
objj_msgSend(_194,"activate:",YES);
var _195=objj_msgSend(_trackingMenuItem,"submenu");
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"addObserver:selector:name:object:",self,sel_getUid("menuDidEndTracking:"),CPMenuDidEndTrackingNotification,_195);
objj_msgSend(CPMenu,"_popUpContextMenu:withEvent:forView:withFont:forMenuBar:",_195,objj_msgSend(CPEvent,"mouseEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:clickCount:pressure:",CPLeftMouseDown,CGPointMake(CGRectGetMinX(_193),CGRectGetMaxY(_193)),objj_msgSend(_192,"modifierFlags"),objj_msgSend(_192,"timestamp"),objj_msgSend(self,"windowNumber"),nil,0,objj_msgSend(_192,"clickCount"),objj_msgSend(_192,"pressure")),objj_msgSend(self,"contentView"),nil,YES);
}
}),new objj_method(sel_getUid("menuDidEndTracking:"),function(self,_cmd,_198){
with(self){
objj_msgSend(_highlightView,"removeFromSuperview");
objj_msgSend(objj_msgSend(_trackingMenuItem,"_menuItemView"),"activate:",NO);
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"removeObserver:name:object:",self,CPMenuDidEndTrackingNotification,objj_msgSend(_198,"object"));
}
}),new objj_method(sel_getUid("tile"),function(self,_cmd){
with(self){
var _19b=objj_msgSend(_menu,"itemArray"),_19c=0,_19d=_19b.length,x=_149,y=0,_1a0=YES;
for(;_19c<_19d;++_19c){
var item=_19b[_19c];
...
var _1a2=objj_msgSend(item,"_menuItemView"),_1a3=objj_msgSend(_1a2,"frame");
if(_1a0){
objj_msgSend(_1a2,"setFrameOrigin:",CGPointMake(x,(_1-1-CGRectGetHeight(_1a3))/2));
x+=CGRectGetWidth(objj_msgSend(_1a2,"frame"))+_148;
}else{
objj_msgSend(_1a2,"setFrameOrigin:",CGPointMake(x-CGRectGetWidth(_1a3),(_1-1-CGRectGetHeight(_1a3))/2));
x=CGRectGetMinX(objj_msgSend(_1a2,"frame"))-_148;
}
}
var _1a4=objj_msgSend(objj_msgSend(self,"contentView"),"bounds"),_1a5=objj_msgSend(_titleField,"frame");
if(objj_msgSend(_iconImageView,"isHidden")){
objj_msgSend(_titleField,"setFrameOrigin:",CGPointMake((CGRectGetWidth(_1a4)-CGRectGetWidth(_1a5))/2,(CGRectGetHeight(_1a4)-CGRectGetHeight(_1a5))/2));
}else{
var _1a6=objj_msgSend(_iconImageView,"frame"),_1a7=CGRectGetWidth(_1a6),_1a8=_1a7+CGRectGetWidth(_1a5);
objj_msgSend(_iconImageView,"setFrameOrigin:",CGPointMake((CGRectGetWidth(_1a4)-_1a8)/2,(CGRectGetHeight(_1a4)-CGRectGetHeight(_1a6))/2));
objj_msgSend(_titleField,"setFrameOrigin:",CGPointMake((CGRectGetWidth(_1a4)-_1a8)/2+_1a7,(CGRectGetHeight(_1a4)-CGRectGetHeight(_1a5))/2));
}
}
}),new objj_method(sel_getUid("setFrameSize:"),function(self,_cmd,_1ab){
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPPanel")},"setFrameSize:",_1ab);
objj_msgSend(self,"tile");
}
})]);
...
var _1ae=objj_msgSend(CPBundle,"bundleForClass:",self);
...
p;19;CPSecureTextField.ji;13;CPTextField.jc;813;
var _1=4,_2=3;
...
p;13;CPSplitView.ji;9;CPImage.ji;8;CPView.jc;15280;
...
var _73=0,_74=objj_msgSend(_subviews,"count"),_75=objj_msgSend(_70,"bounds"),_76=objj_msgSend(_70,"dividerThickness");
for(;_73<_74;++_73){
var _77=_subviews[_73],_78=CGRectMakeCopy(_75);
if(_73+1==_74){
_78.size[_sizeComponent]=_75.size[_sizeComponent]-_78.origin[_originComponent];
}else{
_78.size[_sizeComponent]=_75.size[_sizeComponent]*(objj_msgSend(_77,"frame").size[_sizeComponent]/_72[_sizeComponent]);
}
_75.origin[_originComponent]+=_78.size[_sizeComponent]+_76;
objj_msgSend(_77,"setFrame:",_78);
}
objj_msgSend(_70,"_postNotificationDidResize");
}
}),new objj_method(sel_getUid("setDelegate:"),function(_79,_7a,_7b){
with(_79){
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("splitViewDidResizeSubviews:"))){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"removeObserver:name:object:",_delegate,CPSplitViewDidResizeSubviewsNotification,_79);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("splitViewWillResizeSubviews:"))){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"removeObserver:name:object:",_delegate,CPSplitViewWillResizeSubviewsNotification,_79);
}
_delegate=_7b;
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("splitViewDidResizeSubviews:"))){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"addObserver:selector:name:object:",_delegate,sel_getUid("splitViewDidResizeSubviews:"),CPSplitViewDidResizeSubviewsNotification,_79);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("splitViewWillResizeSubviews:"))){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"addObserver:selector:name:object:",_delegate,sel_getUid("splitViewWillResizeSubviews:"),CPSplitViewWillResizeSubviewsNotification,_79);
}
}
}),new objj_method(sel_getUid("_postNotificationWillResize"),function(_7c,_7d){
with(_7c){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:",CPSplitViewWillResizeSubviewsNotification,_7c);
}
}),new objj_method(sel_getUid("_postNotificationDidResize"),function(_7e,_7f){
with(_7e){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:",CPSplitViewDidResizeSubviewsNotification,_7e);
}
})]);
class_addMethods(_4,[new objj_method(sel_getUid("initialize"),function(_80,_81){
with(_80){
if(_80!=objj_msgSend(CPSplitView,"class")){
return;
}
var _82=objj_msgSend(CPBundle,"bundleForClass:",_80);
_1=objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPSplitView/CPSplitViewHorizontal.png"),CPSizeMake(5,10));
_2=objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_82,"pathForResource:","CPSplitView/CPSplitViewVertical.png"),CPSizeMake(10,5));
}
})]);
var _83="CPSplitViewDelegateKey",_84="CPSplitViewIsVerticalKey",_85="CPSplitViewIsPaneSplitterKey";
...
var _4=_3.isa;
class_addMethods(_3,[new objj_method(sel_getUid("initWithCoder:"),function(_86,_87,_88){
with(_86){
_86=objj_msgSendSuper({receiver:_86,super_class:objj_getClass("CPView")},"initWithCoder:",_88);
if(_86){
_currentDivider=CPNotFound;
_DOMDividerElements=[];
_delegate=objj_msgSend(_88,"decodeObjectForKey:",_83);
_isPaneSplitter=objj_msgSend(_88,"decodeBoolForKey:",_85);
objj_msgSend(_86,"_setVertical:",objj_msgSend(_88,"decodeBoolForKey:",_84));
}
return _86;
}
...
objj_msgSend(_8b,"encodeConditionalObject:forKey:",_delegate,_83);
objj_msgSend(_8b,"encodeBool:forKey:",_isVertical,_84);
objj_msgSend(_8b,"encodeBool:forKey:",_isPaneSplitter,_85);
}
})]);
...
p;13;CPTextField.ji;11;CPControl.ji;17;CPStringDrawing.jc;11927;
...
var _6=_5.isa;
class_addMethods(_5,[new objj_method(sel_getUid("string"),function(_7,_8){
with(_7){
return _7;
}
})]);
var _5=objj_allocateClassPair(CPControl,"CPTextField"),_6=_5.isa;
class_addIvars(_5,[new objj_ivar("_isEditable"),new objj_ivar("_isSelectable"),new objj_ivar("_isBordered"),new objj_ivar("_isBezeled"),new objj_ivar("_bezelStyle"),new objj_ivar("_drawsBackground"),new objj_ivar("_lineBreakMode"),new objj_ivar("_textFieldBackgroundColor"),new objj_ivar("_placeholderString"),new objj_ivar("_delegate"),new objj_ivar("_textDidChangeValue")]);
objj_registerClassPair(_5);
objj_addClassForBundle(_5,objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
class_addMethods(_5,[new objj_method(sel_getUid("initWithFrame:"),function(_9,_a,_b){
with(_9){
_9=objj_msgSendSuper({receiver:_9,super_class:objj_getClass("CPControl")},"initWithFrame:",_b);
if(_9){
_value="";
_placeholderString="";
_sendActionOn=CPKeyUpMask|CPKeyDownMask;
objj_msgSend(_9,"setAlignment:",CPLeftTextAlignment);
}
return _9;
}
...
if(_delegate){
objj_msgSend(_f,"removeObserver:name:object:",_delegate,CPControlTextDidBeginEditingNotification,_c);
objj_msgSend(_f,"removeObserver:name:object:",_delegate,CPControlTextDidChangeNotification,_c);
objj_msgSend(_f,"removeObserver:name:object:",_delegate,CPControlTextDidEndEditingNotification,_c);
}
_delegate=_e;
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidBeginEditing:"))){
objj_msgSend(_f,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidBeginEditing:"),CPControlTextDidBeginEditingNotification,_c);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidChange:"))){
objj_msgSend(_f,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidChange:"),CPControlTextDidChangeNotification,_c);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("controlTextDidEndEditing:"))){
objj_msgSend(_f,"addObserver:selector:name:object:",_delegate,sel_getUid("controlTextDidEndEditing:"),CPControlTextDidEndEditingNotification,_c);
}
}
}),new objj_method(sel_getUid("delegate"),function(_10,_11){
with(_10){
return _delegate;
}
}),new objj_method(sel_getUid("setBezeled:"),function(_12,_13,_14){
with(_12){
if(_isBezeled==_14){
return;
}
_isBezeled=_14;
objj_msgSend(_12,"_updateBackground");
}
}),new objj_method(sel_getUid("isBezeled"),function(_15,_16){
with(_15){
return _isBezeled;
}
}),new objj_method(sel_getUid("setBezelStyle:"),function(_17,_18,_19){
with(_17){
if(_bezelStyle==_19){
return;
}
_bezelStyle=_19;
objj_msgSend(_17,"_updateBackground");
}
}),new objj_method(sel_getUid("bezelStyle"),function(_1a,_1b){
with(_1a){
return _bezelStyle;
}
}),new objj_method(sel_getUid("setBordered:"),function(_1c,_1d,_1e){
with(_1c){
if(_isBordered==_1e){
return;
}
_isBordered=_1e;
objj_msgSend(_1c,"_updateBackground");
}
}),new objj_method(sel_getUid("isBordered"),function(_1f,_20){
with(_1f){
return _isBordered;
}
}),new objj_method(sel_getUid("setDrawsBackground:"),function(_21,_22,_23){
with(_21){
if(_drawsBackground==_23){
return;
}
_drawsBackground=_23;
objj_msgSend(_21,"_updateBackground");
}
}),new objj_method(sel_getUid("drawsBackground"),function(_24,_25){
with(_24){
return _drawsBackground;
}
}),new objj_method(sel_getUid("setTextFieldBackgroundColor:"),function(_26,_27,_28){
with(_26){
if(_textFieldBackgroundColor==_28){
return;
}
_textFieldBackgroundColor=_28;
objj_msgSend(_26,"_updateBackground");
}
}),new objj_method(sel_getUid("textFieldBackgroundColor"),function(_29,_2a){
with(_29){
return _textFieldBackgroundColor;
}
}),new objj_method(sel_getUid("_updateBackground"),function(_2b,_2c){
with(_2b){
if(_isBezeled){
if(_bezelStyle==CPTextFieldSquareBezel){
if(!_3){
var _2d=objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(CPTextField,"class"));
_3=objj_msgSend(CPColor,"colorWithPatternImage:",objj_msgSend(objj_msgSend(CPNinePartImage,"alloc"),"initWithImageSlices:",[objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelSquare0.png"),CGSizeMake(2,3)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelSquare1.png"),CGSizeMake(1,3)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelSquare2.png"),CGSizeMake(2,3)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelSquare3.png"),CGSizeMake(2,1)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelSquare4.png"),CGSizeMake(1,1)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelSquare5.png"),CGSizeMake(2,1)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelSquare6.png"),CGSizeMake(2,2)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelSquare7.png"),CGSizeMake(1,2)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelSquare8.png"),CGSizeMake(2,2))]));
}
objj_msgSend(_2b,"setBackgroundColor:",_3);
}else{
if(_bezelStyle==CPTextFieldRoundedBezel){
if(!_4){
var _2d=objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(CPTextField,"class"));
_4=objj_msgSend(CPColor,"colorWithPatternImage:",objj_msgSend(objj_msgSend(CPThreePartImage,"alloc"),"initWithImageSlices:isVertical:",[objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelRounded0.png"),CGSizeMake(12,22)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelRounded1.png"),CGSizeMake(16,22)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_2d,"pathForResource:","CPTextField/CPTextFieldBezelRounded2.png"),CGSizeMake(12,22))],NO));
}
objj_msgSend(_2b,"setBackgroundColor:",_4);
}
}
}else{
if(_drawsBackground){
objj_msgSend(_2b,"setBackgroundColor:",_textFieldBackgroundColor);
}else{
objj_msgSend(_2b,"setBackgroundColor:",nil);
}
}
}
}),new objj_method(sel_getUid("acceptsFirstResponder"),function(_2e,_2f){
with(_2e){
return _isEditable;
}
}),new objj_method(sel_getUid("becomeFirstResponder"),function(_30,_31){
with(_30){
var _32=objj_msgSend(_30,"stringValue");
objj_msgSend(_30,"setStringValue:","");
return YES;
}
}),new objj_method(sel_getUid("resignFirstResponder"),function(_33,_34){
with(_33){
objj_msgSend(_33,"textDidEndEditing:",objj_msgSend(CPNotification,"notificationWithName:object:userInfo:",CPControlTextDidBeginEditingNotification,_33,nil));
return YES;
}
}),new objj_method(sel_getUid("mouseUp:"),function(_35,_36,_37){
with(_35){
if(_isEditable&&objj_msgSend(objj_msgSend(_35,"window"),"firstResponder")==_35){
return;
}
objj_msgSendSuper({receiver:_35,super_class:objj_getClass("CPControl")},"mouseUp:",_37);
}
}),new objj_method(sel_getUid("setEditable:"),function(_38,_39,_3a){
with(_38){
_isEditable=_3a;
}
}),new objj_method(sel_getUid("isEditable"),function(_3b,_3c){
with(_3b){
return _isEditable;
}
}),new objj_method(sel_getUid("setFrameSize:"),function(_3d,_3e,_3f){
with(_3d){
objj_msgSendSuper({receiver:_3d,super_class:objj_getClass("CPControl")},"setFrameSize:",_3f);
}
}),new objj_method(sel_getUid("isSelectable"),function(_40,_41){
with(_40){
return _isSelectable;
}
}),new objj_method(sel_getUid("setSelectable:"),function(_42,_43,_44){
with(_42){
_isSelectable=_44;
}
}),new objj_method(sel_getUid("setAlignment:"),function(_45,_46,_47){
with(_45){
if(objj_msgSend(_45,"alignment")==_47){
return;
}
objj_msgSendSuper({receiver:_45,super_class:objj_getClass("CPControl")},"setAlignment:",_47);
}
}),new objj_method(sel_getUid("setLineBreakMode:"),function(_48,_49,_4a){
with(_48){
_lineBreakMode=_4a;
}
}),new objj_method(sel_getUid("objectValue"),function(_4b,_4c){
with(_4b){
if(objj_msgSendSuper({receiver:_4b,super_class:objj_getClass("CPControl")},"objectValue")==objj_msgSend(_4b,"placeholderString")){
return "";
}
return objj_msgSendSuper({receiver:_4b,super_class:objj_getClass("CPControl")},"objectValue");
}
}),new objj_method(sel_getUid("setObjectValue:"),function(_4d,_4e,_4f){
with(_4d){
objj_msgSendSuper({receiver:_4d,super_class:objj_getClass("CPControl")},"setObjectValue:",_4f);
}
}),new objj_method(sel_getUid("placeholderString"),function(_50,_51){
with(_50){
return _placeholderString;
}
}),new objj_method(sel_getUid("setPlaceholderString:"),function(_52,_53,_54){
with(_52){
_placeholderString=_54;
if(!_value){
objj_msgSend(_52,"setStringValue:",_54);
}
}
}),new objj_method(sel_getUid("sizeToFit"),function(_55,_56){
with(_55){
}
...
var _5a="CPTextFieldIsEditableKey",_5b="CPTextFieldIsSelectableKey",_5c="CPTextFieldIsBorderedKey",_5d="CPTextFieldIsBezeledKey",_5e="CPTextFieldBezelStyleKey",_5f="CPTextFieldDrawsBackgroundKey",_60="CPTextFieldLineBreakModeKey",_61="CPTextFieldBackgroundColorKey",_62="CPTextFieldPlaceholderStringKey";
var _5=objj_getClass("CPTextField");
if(!_5){
objj_exception_throw(new objj_exception(OBJJClassNotFoundException,"*** Could not find definition for class \"CPTextField\""));
}
var _6=_5.isa;
class_addMethods(_5,[new objj_method(sel_getUid("initWithCoder:"),function(_63,_64,_65){
with(_63){
_63=objj_msgSendSuper({receiver:_63,super_class:objj_getClass("CPControl")},"initWithCoder:",_65);
if(_63){
objj_msgSend(_63,"setEditable:",objj_msgSend(_65,"decodeBoolForKey:",_5a));
objj_msgSend(_63,"setSelectable:",objj_msgSend(_65,"decodeBoolForKey:",_5b));
objj_msgSend(_63,"setBordered:",objj_msgSend(_65,"decodeBoolForKey:",_5c));
objj_msgSend(_63,"setBezeled:",objj_msgSend(_65,"decodeBoolForKey:",_5d));
objj_msgSend(_63,"setBezelStyle:",objj_msgSend(_65,"decodeIntForKey:",_5e));
objj_msgSend(_63,"setDrawsBackground:",objj_msgSend(_65,"decodeBoolForKey:",_5f));
objj_msgSend(_63,"setLineBreakMode:",objj_msgSend(_65,"decodeIntForKey:",_60));
objj_msgSend(_63,"setTextFieldBackgroundColor:",objj_msgSend(_65,"decodeObjectForKey:",_61));
objj_msgSend(_63,"setPlaceholderString:",objj_msgSend(_65,"decodeObjectForKey:",_62));
}
return _63;
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_66,_67,_68){
with(_66){
objj_msgSendSuper({receiver:_66,super_class:objj_getClass("CPControl")},"encodeWithCoder:",_68);
objj_msgSend(_68,"encodeBool:forKey:",_isEditable,_5a);
objj_msgSend(_68,"encodeBool:forKey:",_isSelectable,_5b);
objj_msgSend(_68,"encodeBool:forKey:",_isBordered,_5c);
objj_msgSend(_68,"encodeBool:forKey:",_isBezeled,_5d);
objj_msgSend(_68,"encodeInt:forKey:",_bezelStyle,_5e);
objj_msgSend(_68,"encodeBool:forKey:",_drawsBackground,_5f);
objj_msgSend(_68,"encodeInt:forKey:",_lineBreakMode,_60);
objj_msgSend(_68,"encodeObject:forKey:",_textFieldBackgroundColor,_61);
objj_msgSend(_68,"encodeObject:forKey:",_placeholderString,_62);
}
})]);
...
p;8;CPView.jI;20;Foundation/CPArray.jI;26;Foundation/CPObjJRuntime.ji;19;CGAffineTransform.ji;12;CGGeometry.ji;9;CPColor.ji;20;CPDOMDisplayServer.ji;12;CPGeometry.ji;13;CPResponder.ji;19;CPGraphicsContext.jc;28295;
CPViewNotSizable=0;
CPViewMinXMargin=1;
...
_isHidden=NO;
_hitTests=YES;
_displayHash=objj_msgSend(_8,"hash");
}
return _8;
}
}),new objj_method(sel_getUid("superview"),function(_d,_e){
with(_d){
return _superview;
}
}),new objj_method(sel_getUid("subviews"),function(_f,_10){
with(_f){
return _subviews;
}
}),new objj_method(sel_getUid("window"),function(_11,_12){
with(_11){
return _window;
}
}),new objj_method(sel_getUid("addSubview:"),function(_13,_14,_15){
with(_13){
objj_msgSend(_13,"_insertSubview:atIndex:",_15,CPNotFound);
}
}),new objj_method(sel_getUid("addSubview:positioned:relativeTo:"),function(_16,_17,_18,_19,_1a){
with(_16){
var _1b=_1a?objj_msgSend(_subviews,"indexOfObjectIdenticalTo:",_1a):CPNotFound;
if(_1b===CPNotFound){
_1b=(_19===CPWindowAbove)?objj_msgSend(_subviews,"count"):0;
}else{
if(_19===CPWindowAbove){
++_1b;
}
}
objj_msgSend(_16,"_insertSubview:atIndex:",_18,_1b);
}
}),new objj_method(sel_getUid("_insertSubview:atIndex:"),function(_1c,_1d,_1e,_1f){
with(_1c){
var _20=_subviews.length;
if(_1e._superview==_1c){
var _21=objj_msgSend(_subviews,"indexOfObjectIdenticalTo:",_1e);
if(_21===_1f||_21===_20-1&&_1f===_20){
return;
}
objj_msgSend(_subviews,"removeObjectAtIndex:",_21);
if(_1f>_21){
--_1f;
}
--_20;
}else{
objj_msgSend(_1e,"removeFromSuperview");
objj_msgSend(_1e,"_setWindow:",_window);
objj_msgSend(_1e,"viewWillMoveToSuperview:",_1c);
_1e._superview=_1c;
}
if(_1f===CPNotFound||_1f>=_20){
_subviews.push(_1e);
}else{
_subviews.splice(_1f,0,_1e);
}
objj_msgSend(_1e,"setNextResponder:",_1c);
objj_msgSend(_1e,"viewDidMoveToSuperview");
objj_msgSend(_1c,"didAddSubview:",_1e);
}
}),new objj_method(sel_getUid("didAddSubview:"),function(_22,_23,_24){
with(_22){
}
}),new objj_method(sel_getUid("removeFromSuperview"),function(_25,_26){
with(_25){
if(!_superview){
return;
}
objj_msgSend(_superview,"willRemoveSubview:",_25);
objj_msgSend(objj_msgSend(_superview,"subviews"),"removeObject:",_25);
_superview=nil;
objj_msgSend(_25,"_setWindow:",nil);
}
}),new objj_method(sel_getUid("replaceSubview:with:"),function(_27,_28,_29,_2a){
with(_27){
if(_29._superview!=_27){
return;
}
var _2b=objj_msgSend(_subviews,"indexOfObjectIdenticalTo:",_29);
objj_msgSend(_29,"removeFromSuperview");
objj_msgSend(_27,"_insertSubview:atIndex:",_2a,_2b);
}
}),new objj_method(sel_getUid("_setWindow:"),function(_2c,_2d,_2e){
with(_2c){
if(objj_msgSend(_window,"firstResponder")==_2c){
objj_msgSend(_window,"makeFirstResponder:",nil);
}
objj_msgSend(_2c,"viewWillMoveToWindow:",_2e);
objj_msgSend(_subviews,"makeObjectsPerformSelector:withObject:",sel_getUid("_setWindow:"),_2e);
_window=_2e;
objj_msgSend(_2c,"viewDidMoveToWindow");
}
...
with(_40){
var _42=_40;
while(!objj_msgSend(_42,"isKindOfClass:",objj_msgSend(_CPMenuItemView,"class"))){
...
}),new objj_method(sel_getUid("tag"),function(_43,_44){
with(_43){
return _tag;
}
}),new objj_method(sel_getUid("isFlipped"),function(_45,_46){
with(_45){
return YES;
}
}),new objj_method(sel_getUid("setFrame:"),function(_47,_48,_49){
with(_47){
if(((_frame.origin.x==_49.origin.x&&_frame.origin.y==_49.origin.y)&&(_frame.size.width==_49.size.width&&_frame.size.height==_49.size.height))){
return;
}
_inhibitFrameAndBoundsChangedNotifications=YES;
objj_msgSend(_47,"setFrameOrigin:",_49.origin);
objj_msgSend(_47,"setFrameSize:",_49.size);
_inhibitFrameAndBoundsChangedNotifications=NO;
if(_postsFrameChangedNotifications){
objj_msgSend(_3,"postNotificationName:object:",CPViewFrameDidChangeNotification,_47);
}
}
}),new objj_method(sel_getUid("frame"),function(_4a,_4b){
with(_4a){
...
with(_4c){
var _4f=_frame.origin;
if(!_4e||(_4f.x==_4e.x&&_4f.y==_4e.y)){
return;
}
_4f.x=_4e.x;
_4f.y=_4e.y;
if(_postsFrameChangedNotifications&&!_inhibitFrameAndBoundsChangedNotifications){
objj_msgSend(_3,"postNotificationName:object:",CPViewFrameDidChangeNotification,_4c);
}
}
}),new objj_method(sel_getUid("setFrameSize:"),function(_50,_51,_52){
with(_50){
var _53=_frame.size;
if(!_52||(_53.width==_52.width&&_53.height==_52.height)){
return;
}
var _54={width:_53.width,height:_53.height};
_53.width=_52.width;
_53.height=_52.height;
if(YES){
_bounds.size.width=_52.width;
_bounds.size.height=_52.height;
}
if(_postsFrameChangedNotifications&&!_inhibitFrameAndBoundsChangedNotifications){
objj_msgSend(_3,"postNotificationName:object:",CPViewFrameDidChangeNotification,_50);
}
if(_layer){
objj_msgSend(_layer,"_owningViewBoundsChanged");
}
if(_autoresizesSubviews){
objj_msgSend(_50,"resizeSubviewsWithOldSize:",_54);
}
objj_msgSend(_50,"setNeedsDisplay:",YES);
}
}),new objj_method(sel_getUid("setBounds:"),function(_55,_56,_57){
with(_55){
if(((_bounds.origin.x==_57.origin.x&&_bounds.origin.y==_57.origin.y)&&(_bounds.size.width==_57.size.width&&_bounds.size.height==_57.size.height))){
return;
}
_inhibitFrameAndBoundsChangedNotifications=YES;
objj_msgSend(_55,"setBoundsOrigin:",_57.origin);
objj_msgSend(_55,"setBoundsSize:",_57.size);
_inhibitFrameAndBoundsChangedNotifications=NO;
if(_postsBoundsChangedNotifications){
objj_msgSend(_3,"postNotificationName:object:",CPViewBoundsDidChangeNotification,_55);
}
}
}),new objj_method(sel_getUid("bounds"),function(_58,_59){
with(_58){
return {origin:{x:_bounds.origin.x,y:_bounds.origin.y},size:{width:_bounds.size.width,height:_bounds.size.height}};
}
}),new objj_method(sel_getUid("setBoundsOrigin:"),function(_5a,_5b,_5c){
with(_5a){
var _5d=_bounds.origin;
if((_5d.x==_5c.x&&_5d.y==_5c.y)){
return;
}
_5d.x=_5c.x;
_5d.y=_5c.y;
if(_5d.x!=0||_5d.y!=0){
_boundsTransform={a:1,b:0,c:0,d:1,tx:-_5d.x,ty:-_5d.y};
...
objj_msgSend(_3,"postNotificationName:object:",CPViewBoundsDidChangeNotification,_5a);
}
}
}),new objj_method(sel_getUid("setBoundsSize:"),function(_5e,_5f,_60){
with(_5e){
var _61=_bounds.size;
if((_61.width==_60.width&&_61.height==_60.height)){
return;
}
var _62=_frame.size;
if(!(_61.width==_62.width&&_61.height==_62.height)){
var _63=_bounds.origin;
_63.x/=_61.width/_62.width;
_63.y/=_61.height/_62.height;
}
_61.width=_60.width;
...
if(_postsBoundsChangedNotifications&&!_inhibitFrameAndBoundsChangedNotifications){
objj_msgSend(_3,"postNotificationName:object:",CPViewBoundsDidChangeNotification,_5e);
}
}
}),new objj_method(sel_getUid("resizeWithOldSuperviewSize:"),function(_64,_65,_66){
with(_64){
var _67=_autoresizingMask;
if(_67==CPViewNotSizable){
return;
}
var _68=_superview._frame,_69={origin:{x:_frame.origin.x,y:_frame.origin.y},size:{width:_frame.size.width,height:_frame.size.height}},dX=((_68.size.width)-_66.width)/(((_67&CPViewMinXMargin)?1:0)+(_67&CPViewWidthSizable?1:0)+(_67&CPViewMaxXMargin?1:0)),dY=((_68.size.height)-_66.height)/((_67&CPViewMinYMargin?1:0)+(_67&CPViewHeightSizable?1:0)+(_67&CPViewMaxYMargin?1:0));
if(_67&CPViewMinXMargin){
_69.origin.x+=dX;
}
if(_67&CPViewWidthSizable){
_69.size.width+=dX;
}
if(_67&CPViewMinYMargin){
_69.origin.y+=dY;
}
if(_67&CPViewHeightSizable){
_69.size.height+=dY;
}
objj_msgSend(_64,"setFrame:",_69);
}
}),new objj_method(sel_getUid("resizeSubviewsWithOldSize:"),function(_6c,_6d,_6e){
with(_6c){
var _6f=_subviews.length;
while(_6f--){
objj_msgSend(_subviews[_6f],"resizeWithOldSuperviewSize:",_6e);
}
}
}),new objj_method(sel_getUid("setAutoresizesSubviews:"),function(_70,_71,_72){
with(_70){
_autoresizesSubviews=_72;
}
}),new objj_method(sel_getUid("autoresizesSubviews"),function(_73,_74){
with(_73){
return _autoresizesSubviews;
}
}),new objj_method(sel_getUid("setAutoresizingMask:"),function(_75,_76,_77){
with(_75){
_autoresizingMask=_77;
}
}),new objj_method(sel_getUid("autoresizingMask"),function(_78,_79){
with(_78){
return _autoresizingMask;
}
}),new objj_method(sel_getUid("enterFullScreenMode:withOptions:"),function(_7a,_7b,_7c,_7d){
with(_7a){
_fullScreenModeState=_7e(_7a);
var _7f=objj_msgSend(objj_msgSend(CPWindow,"alloc"),"initWithContentRect:styleMask:",objj_msgSend(objj_msgSend(CPDOMWindowBridge,"sharedDOMWindowBridge"),"contentBounds"),CPBorderlessWindowMask);
objj_msgSend(_7f,"setLevel:",CPScreenSaverWindowLevel);
objj_msgSend(_7f,"setAutoresizingMask:",CPViewWidthSizable|CPViewHeightSizable);
var _80=objj_msgSend(_7f,"contentView");
objj_msgSend(_80,"setBackgroundColor:",objj_msgSend(CPColor,"blackColor"));
objj_msgSend(_80,"addSubview:",_7a);
objj_msgSend(_7a,"setAutoresizingMask:",CPViewWidthSizable|CPViewHeightSizable);
objj_msgSend(_7a,"setFrame:",CGRectMakeCopy(objj_msgSend(_80,"bounds")));
objj_msgSend(_7f,"makeKeyAndOrderFront:",_7a);
objj_msgSend(_7f,"makeFirstResponder:",_7a);
_isInFullScreenMode=YES;
return YES;
}
}),new objj_method(sel_getUid("exitFullScreenModeWithOptions:"),function(_81,_82,_83){
with(_81){
if(!_isInFullScreenMode){
return;
}
_isInFullScreenMode=NO;
objj_msgSend(_81,"setFrame:",_fullScreenModeState.frame);
objj_msgSend(_81,"setAutoresizingMask:",_fullScreenModeState.autoresizingMask);
objj_msgSend(_fullScreenModeState.superview,"_insertSubview:atIndex:",_81,_fullScreenModeState.index);
objj_msgSend(objj_msgSend(_81,"window"),"orderOut:",_81);
}
}),new objj_method(sel_getUid("isInFullScreenMode"),function(_84,_85){
with(_84){
return _isInFullScreenMode;
}
}),new objj_method(sel_getUid("setHidden:"),function(_86,_87,_88){
with(_86){
if(_isHidden==_88){
return;
}
...
}),new objj_method(sel_getUid("isHidden"),function(_89,_8a){
with(_89){
return _isHidden;
}
}),new objj_method(sel_getUid("setAlphaValue:"),function(_8b,_8c,_8d){
with(_8b){
if(_opacity==_8d){
return;
}
...
}),new objj_method(sel_getUid("alphaValue"),function(_8e,_8f){
with(_8e){
return _opacity;
}
}),new objj_method(sel_getUid("isHiddenOrHasHiddenAncestor"),function(_90,_91){
with(_90){
var _92=_90;
while(!objj_msgSend(_92,"isHidden")){
_92=objj_msgSend(_92,"superview");
}
return _92!=nil;
}
}),new objj_method(sel_getUid("acceptsFirstMouse:"),function(_93,_94,_95){
with(_93){
return YES;
}
}),new objj_method(sel_getUid("hitTests"),function(_96,_97){
with(_96){
return _hitTests;
}
}),new objj_method(sel_getUid("setHitTests:"),function(_98,_99,_9a){
with(_98){
_hitTests=_9a;
}
}),new objj_method(sel_getUid("hitTest:"),function(_9b,_9c,_9d){
with(_9b){
if(_isHidden||!_hitTests||!CPRectContainsPoint(_frame,_9d)){
return nil;
}
var _9e=nil,i=_subviews.length,_a0={x:_9d.x-(_frame.origin.x),y:_9d.y-(_frame.origin.y)};
if(_inverseBoundsTransform){
_a0={x:_a0.x*_inverseBoundsTransform.a+_a0.y*_inverseBoundsTransform.c+_inverseBoundsTransform.tx,y:_a0.x*_inverseBoundsTransform.b+_a0.y*_inverseBoundsTransform.d+_inverseBoundsTransform.ty};
}
while(i--){
if(_9e=objj_msgSend(_subviews[i],"hitTest:",_a0)){
return _9e;
}
}
return _9b;
}
}),new objj_method(sel_getUid("mouseDownCanMoveWindow"),function(_a1,_a2){
with(_a1){
return !objj_msgSend(_a1,"isOpaque");
}
}),new objj_method(sel_getUid("mouseDown:"),function(_a3,_a4,_a5){
with(_a3){
if(objj_msgSend(_a3,"mouseDownCanMoveWindow")){
objj_msgSendSuper({receiver:_a3,super_class:objj_getClass("CPResponder")},"mouseDown:",_a5);
}
}
}),new objj_method(sel_getUid("setBackgroundColor:"),function(_a6,_a7,_a8){
with(_a6){
if(_backgroundColor==_a8){
return;
}
_backgroundColor=_a8;
}
}),new objj_method(sel_getUid("backgroundColor"),function(_a9,_aa){
with(_a9){
return _backgroundColor;
}
}),new objj_method(sel_getUid("convertPoint:fromView:"),function(_ab,_ac,_ad,_ae){
with(_ab){
return CGPointApplyAffineTransform(_ad,_af(_ae,_ab));
}
}),new objj_method(sel_getUid("convertPoint:toView:"),function(_b0,_b1,_b2,_b3){
with(_b0){
return CGPointApplyAffineTransform(_b2,_af(_b0,_b3));
}
}),new objj_method(sel_getUid("convertSize:fromView:"),function(_b4,_b5,_b6,_b7){
with(_b4){
return CGSizeApplyAffineTransform(_b6,_af(_b7,_b4));
}
}),new objj_method(sel_getUid("convertSize:toView:"),function(_b8,_b9,_ba,_bb){
with(_b8){
return CGSizeApplyAffineTransform(_ba,_af(_b8,_bb));
}
}),new objj_method(sel_getUid("convertRect:fromView:"),function(_bc,_bd,_be,_bf){
with(_bc){
return CGRectApplyAffineTransform(_be,_af(_bf,_bc));
}
}),new objj_method(sel_getUid("convertRect:toView:"),function(_c0,_c1,_c2,_c3){
with(_c0){
return CGRectApplyAffineTransform(_c2,_af(_c0,_c3));
}
}),new objj_method(sel_getUid("setPostsFrameChangedNotifications:"),function(_c4,_c5,_c6){
with(_c4){
if(_postsFrameChangedNotifications==_c6){
return;
}
_postsFrameChangedNotifications=_c6;
if(_postsFrameChangedNotifications){
objj_msgSend(_3,"postNotificationName:object:",CPViewFrameDidChangeNotification,_c4);
}
}
}),new objj_method(sel_getUid("postsFrameChangedNotifications"),function(_c7,_c8){
with(_c7){
return _postsFrameChangedNotifications;
}
}),new objj_method(sel_getUid("setPostsBoundsChangedNotifications:"),function(_c9,_ca,_cb){
with(_c9){
if(_postsBoundsChangedNotifications==_cb){
return;
}
_postsBoundsChangedNotifications=_cb;
if(_postsBoundsChangedNotifications){
objj_msgSend(_3,"postNotificationName:object:",CPViewBoundsDidChangeNotification,_c9);
}
}
}),new objj_method(sel_getUid("postsBoundsChangedNotifications"),function(_cc,_cd){
with(_cc){
return _postsBoundsChangedNotifications;
}
}),new objj_method(sel_getUid("dragImage:at:offset:event:pasteboard:source:slideBack:"),function(_ce,_cf,_d0,_d1,_d2,_d3,_d4,_d5,_d6){
with(_ce){
objj_msgSend(_window,"dragImage:at:offset:event:pasteboard:source:slideBack:",_d0,objj_msgSend(_ce,"convertPoint:toView:",_d1,nil),_d2,_d3,_d4,_d5,_d6);
}
}),new objj_method(sel_getUid("dragView:at:offset:event:pasteboard:source:slideBack:"),function(_d7,_d8,_d9,_da,_db,_dc,_dd,_de,_df){
with(_d7){
objj_msgSend(_window,"dragView:at:offset:event:pasteboard:source:slideBack:",_d9,objj_msgSend(_d7,"convertPoint:toView:",_da,nil),_db,_dc,_dd,_de,_df);
}
}),new objj_method(sel_getUid("registerForDraggedTypes:"),function(_e0,_e1,_e2){
with(_e0){
_registeredDraggedTypes=objj_msgSend(_e2,"copy");
}
}),new objj_method(sel_getUid("registeredDraggedTypes"),function(_e3,_e4){
with(_e3){
return _registeredDraggedTypes;
}
}),new objj_method(sel_getUid("unregisterDraggedTypes"),function(_e5,_e6){
with(_e5){
_registeredDraggedTypes=nil;
}
}),new objj_method(sel_getUid("drawRect:"),function(_e7,_e8,_e9){
with(_e7){
}
}),new objj_method(sel_getUid("setNeedsDisplay:"),function(_ea,_eb,_ec){
with(_ea){
if(_ec){
objj_msgSend(_ea,"setNeedsDisplayInRect:",objj_msgSend(_ea,"bounds"));
}
}
}),new objj_method(sel_getUid("setNeedsDisplayInRect:"),function(_ed,_ee,_ef){
with(_ed){
if((_ef.size.width<=0||_ef.size.height<=0)){
return;
}
if(_dirtyRect&&!(_dirtyRect.size.width<=0||_dirtyRect.size.height<=0)){
_dirtyRect=CGRectUnion(_ef,_dirtyRect);
}else{
_dirtyRect={origin:{x:_ef.origin.x,y:_ef.origin.y},size:{width:_ef.size.width,height:_ef.size.height}};
}
}
}),new objj_method(sel_getUid("needsDisplay"),function(_f0,_f1){
with(_f0){
return _dirtyRect&&!(_dirtyRect.size.width<=0||_dirtyRect.size.height<=0);
}
}),new objj_method(sel_getUid("displayIfNeeded"),function(_f2,_f3){
with(_f2){
if(objj_msgSend(_f2,"needsDisplay")){
objj_msgSend(_f2,"displayRect:",_dirtyRect);
}
}
}),new objj_method(sel_getUid("display"),function(_f4,_f5){
with(_f4){
objj_msgSend(_f4,"displayRect:",objj_msgSend(_f4,"visibleRect"));
}
}),new objj_method(sel_getUid("displayIfNeededInRect:"),function(_f6,_f7,_f8){
with(_f6){
if(objj_msgSend(_f6,"needsDisplay")){
objj_msgSend(_f6,"displayRect:",_f8);
}
}
}),new objj_method(sel_getUid("displayRect:"),function(_f9,_fa,_fb){
with(_f9){
objj_msgSend(_f9,"viewWillDraw");
objj_msgSend(_f9,"displayRectIgnoringOpacity:inContext:",_fb,nil);
_dirtyRect=NULL;
}
}),new objj_method(sel_getUid("displayRectIgnoringOpacity:inContext:"),function(_fc,_fd,_fe,_ff){
with(_fc){
objj_msgSend(_fc,"lockFocus");
CGContextClearRect(objj_msgSend(objj_msgSend(CPGraphicsContext,"currentContext"),"graphicsPort"),_fe);
objj_msgSend(_fc,"drawRect:",_fe);
objj_msgSend(_fc,"unlockFocus");
}
...
with(self){
if(!_graphicsContext){
var _104=CGBitmapGraphicsContextCreate();
_DOMContentsElement=_104.DOMElement;
_DOMContentsElement.style.zIndex=-100;
_DOMContentsElement.style.overflow="hidden";
_DOMContentsElement.style.position="absolute";
_DOMContentsElement.style.visibility="visible";
...
_graphicsContext=objj_msgSend(CPGraphicsContext,"graphicsContextWithGraphicsPort:flipped:",_104,YES);
}
...
with(self){
var _10d=_superview,_10e=objj_msgSend(CPClipView,"class");
while(_10d&&!objj_msgSend(_10d,"isKindOfClass:",_10e)){
_10d=_10d._superview;
}
return _10d;
}
}),new objj_method(sel_getUid("scrollPoint:"),function(self,_cmd,_111){
with(self){
var _112=objj_msgSend(self,"_enclosingClipView");
if(!_112){
return;
}
objj_msgSend(_112,"scrollToPoint:",objj_msgSend(self,"convertPoint:toView:",_111,_112));
}
}),new objj_method(sel_getUid("scrollRectToVisible:"),function(self,_cmd,_115){
with(self){
var _116=objj_msgSend(self,"visibleRect");
_115=CGRectIntersection(_115,_bounds);
if((_115.size.width<=0||_115.size.height<=0)||CGRectContainsRect(_116,_115)){
return NO;
}
var _117=objj_msgSend(self,"_enclosingClipView");
if(!_117){
return NO;
}
var _118={x:_116.origin.x,y:_116.origin.y};
if((_115.origin.x)<=(_116.origin.x)){
_118.x=(_115.origin.x);
}else{
if((_115.origin.x+_115.size.width)>(_116.origin.x+_116.size.width)){
_118.x+=(_115.origin.x+_115.size.width)-(_116.origin.x+_116.size.width);
}
}
if((_115.origin.y)<=(_116.origin.y)){
_118.y=CGRectGetMinY(_115);
}else{
if((_115.origin.y+_115.size.height)>(_116.origin.y+_116.size.height)){
_118.y+=(_115.origin.y+_115.size.height)-(_116.origin.y+_116.size.height);
}
}
objj_msgSend(_117,"scrollToPoint:",CGPointMake(_118.x,_118.y));
return YES;
}
}),new objj_method(sel_getUid("autoscroll:"),function(self,_cmd,_11b){
with(self){
return NO;
}
}),new objj_method(sel_getUid("adjustScroll:"),function(self,_cmd,_11e){
with(self){
return _11e;
}
}),new objj_method(sel_getUid("scrollRect:by:"),function(self,_cmd,_121,_122){
with(self){
}
}),new objj_method(sel_getUid("enclosingScrollView"),function(self,_cmd){
with(self){
var _125=_superview,_126=objj_msgSend(CPScrollView,"class");
while(_125&&!objj_msgSend(_125,"isKindOfClass:",_126)){
_125=_125._superview;
}
return _125;
}
}),new objj_method(sel_getUid("scrollClipView:toPoint:"),function(self,_cmd,_129,_12a){
with(self){
objj_msgSend(_129,"scrollToPoint:",_12a);
}
}),new objj_method(sel_getUid("reflectScrolledClipView:"),function(self,_cmd,_12d){
with(self){
}
})]);
class_addMethods(_5,[new objj_method(sel_getUid("initialize"),function(self,_cmd){
with(self){
...
var _5=_4.isa;
class_addMethods(_4,[new objj_method(sel_getUid("setLayer:"),function(self,_cmd,_132){
with(self){
if(_layer==_132){
return;
}
...
_layer=_132;
if(_layer){
var _133=CGRectMakeCopy(objj_msgSend(self,"bounds"));
...
}),new objj_method(sel_getUid("setWantsLayer:"),function(self,_cmd,_138){
with(self){
_wantsLayer=_138;
}
...
var _13b="CPViewAutoresizingMask",_13c="CPViewAutoresizesSubviews",_13d="CPViewBackgroundColor",_13e="CPViewBoundsKey",_13f="CPViewFrameKey",_140="CPViewHitTestsKey",_141="CPViewIsHiddenKey",_142="CPViewOpacityKey",_143="CPViewSubviewsKey",_144="CPViewSuperviewKey",_145="CPViewTagKey",_146="CPViewWindowKey";
var _4=objj_getClass("CPView");
if(!_4){
objj_exception_throw(new objj_exception(OBJJClassNotFoundException,"*** Could not find definition for class \"CPView\""));
}
var _5=_4.isa;
class_addMethods(_4,[new objj_method(sel_getUid("initWithCoder:"),function(self,_cmd,_149){
with(self){
_frame=objj_msgSend(_149,"decodeRectForKey:",_13f);
_bounds=objj_msgSend(_149,"decodeRectForKey:",_13e);
self=objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPResponder")},"initWithCoder:",_149);
if(self){
_tag=-1;
if(objj_msgSend(_149,"containsValueForKey:",_145)){
_tag=objj_msgSend(_149,"decodeIntForKey:",_145);
}
_window=objj_msgSend(_149,"decodeObjectForKey:",_146);
_subviews=objj_msgSend(_149,"decodeObjectForKey:",_143);
_superview=objj_msgSend(_149,"decodeObjectForKey:",_144);
_autoresizingMask=objj_msgSend(_149,"decodeIntForKey:",_13b);
_autoresizesSubviews=objj_msgSend(_149,"decodeBoolForKey:",_13c);
_hitTests=objj_msgSend(_149,"decodeObjectForKey:",_140);
_isHidden=objj_msgSend(_149,"decodeObjectForKey:",_141);
_opacity=objj_msgSend(_149,"decodeIntForKey:",_142);
_displayHash=objj_msgSend(self,"hash");
objj_msgSend(self,"setBackgroundColor:",objj_msgSend(_149,"decodeObjectForKey:",_13d));
...
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPResponder")},"encodeWithCoder:",_14c);
if(_tag!=-1){
objj_msgSend(_14c,"encodeInt:forKey:",_tag,_145);
}
objj_msgSend(_14c,"encodeRect:forKey:",_frame,_13f);
objj_msgSend(_14c,"encodeRect:forKey:",_bounds,_13e);
objj_msgSend(_14c,"encodeConditionalObject:forKey:",_window,_146);
objj_msgSend(_14c,"encodeObject:forKey:",_subviews,_143);
objj_msgSend(_14c,"encodeConditionalObject:forKey:",_superview,_144);
objj_msgSend(_14c,"encodeInt:forKey:",_autoresizingMask,_13b);
objj_msgSend(_14c,"encodeBool:forKey:",_autoresizesSubviews,_13c);
objj_msgSend(_14c,"encodeObject:forKey:",_backgroundColor,_13d);
objj_msgSend(_14c,"encodeBool:forKey:",_hitTests,_140);
objj_msgSend(_14c,"encodeBool:forKey:",_isHidden,_141);
objj_msgSend(_14c,"encodeFloat:forKey:",_opacity,_142);
}
})]);
var _7e=function(_14d){
var _14e=_14d._superview;
return {autoresizingMask:_14d._autoresizingMask,frame:CGRectMakeCopy(_14d._frame),index:(_14e?objj_msgSend(_14e._subviews,"indexOfObjectIdenticalTo:",_14d):0),superview:_14e};
};
var _af=function(_14f,_150){
var _151=CGAffineTransformMakeIdentity();
if(_14f){
var view=_14f;
while(view&&view!=_150){
var _153=view._frame;
_151.tx+=(_153.origin.x);
_151.ty+=(_153.origin.y);
if(view._boundsTransform){
var tx=_151.tx*view._boundsTransform.a+_151.ty*view._boundsTransform.c+view._boundsTransform.tx;
_151.ty=_151.tx*view._boundsTransform.b+_151.ty*view._boundsTransform.d+view._boundsTransform.ty;
_151.tx=tx;
var a=_151.a*view._boundsTransform.a+_151.b*view._boundsTransform.c,b=_151.a*view._boundsTransform.b+_151.b*view._boundsTransform.d,c=_151.c*view._boundsTransform.a+_151.d*view._boundsTransform.c;
_151.d=_151.c*view._boundsTransform.b+_151.d*view._boundsTransform.d;
_151.a=a;
_151.b=b;
_151.c=c;
}
...
_151.ty-=(_153.origin.y);
if(view._boundsTransform){
var tx=_151.tx*view._inverseBoundsTransform.a+_151.ty*view._inverseBoundsTransform.c+view._inverseBoundsTransform.tx;
_151.ty=_151.tx*view._inverseBoundsTransform.b+_151.ty*view._inverseBoundsTransform.d+view._inverseBoundsTransform.ty;
_151.tx=tx;
var a=_151.a*view._inverseBoundsTransform.a+_151.b*view._inverseBoundsTransform.c,b=_151.a*view._inverseBoundsTransform.b+_151.b*view._inverseBoundsTransform.d,c=_151.c*view._inverseBoundsTransform.a+_151.d*view._inverseBoundsTransform.c;
_151.d=_151.c*view._inverseBoundsTransform.b+_151.d*view._inverseBoundsTransform.d;
_151.a=a;
_151.b=b;
_151.c=c;
}
...
p;10;CPWindow.jI;33;Foundation/CPNotificationCenter.jI;26;Foundation/CPUndoManager.ji;12;CGGeometry.ji;13;CPAnimation.ji;13;CPResponder.jc;32269;
...
}),new objj_method(sel_getUid("styleMask"),function(_14,_15){
with(_14){
return _styleMask;
}
}),new objj_method(sel_getUid("contentRectForFrameRect:"),function(_16,_17,_18){
with(_16){
var _19=CGRectMakeCopy(objj_msgSend(_windowView,"bounds"));
...
var _1a=CGRectGetHeight(objj_msgSend(_toolbarView,"frame"));
_19.origin.y+=_1a;
_19.size.height-=_1a;
}
return _19;
...
var _1e=objj_msgSend(objj_msgSend(_1b,"class"),"frameRectForContentRect:styleMask:",_1d,_styleMask);
return _1e;
}
}),new objj_method(sel_getUid("frame"),function(_1f,_20){
with(_1f){
...
}),new objj_method(sel_getUid("setFrame:display:animate:"),function(_21,_22,_23,_24,_25){
with(_21){
if(_25){
var _26=objj_msgSend(objj_msgSend(_CPWindowFrameAnimation,"alloc"),"initWithWindow:targetFrame:",_21,_23);
objj_msgSend(_26,"startAnimation");
}else{
objj_msgSend(_21,"setFrameOrigin:",_23.origin);
objj_msgSend(_21,"setFrameSize:",_23.size);
}
}
}),new objj_method(sel_getUid("setFrame:"),function(_27,_28,_29){
with(_27){
objj_msgSend(_27,"setFrame:display:animate:",_29,YES,NO);
}
}),new objj_method(sel_getUid("setFrameOrigin:"),function(_2a,_2b,_2c){
with(_2a){
var _2d=_frame.origin;
if((_2d.x==_2c.x&&_2d.y==_2c.y)){
return;
}
_2d.x=_2c.x;
_2d.y=_2c.y;
...
}),new objj_method(sel_getUid("trackMoveWithEvent:"),function(_31,_32,_33){
with(_31){
var _34=objj_msgSend(_33,"type");
if(_34==CPLeftMouseUp){
return;
}else{
if(_34==CPLeftMouseDown){
_mouseDraggedPoint=objj_msgSend(_31,"convertBaseToBridge:",objj_msgSend(_33,"locationInWindow"));
}else{
if(_34==CPLeftMouseDragged){
var _35=objj_msgSend(_31,"convertBaseToBridge:",objj_msgSend(_33,"locationInWindow"));
objj_msgSend(_31,"setFrameOrigin:",CGPointMake((_frame.origin.x)+(_35.x-_mouseDraggedPoint.x),(_frame.origin.y)+(_35.y-_mouseDraggedPoint.y)));
_mouseDraggedPoint=_35;
}
}
}
objj_msgSend(CPApp,"setTarget:selector:forNextEventMatchingMask:untilDate:inMode:dequeue:",_31,sel_getUid("trackMoveWithEvent:"),CPLeftMouseDraggedMask|CPLeftMouseUpMask,nil,nil,YES);
}
}),new objj_method(sel_getUid("trackResizeWithEvent:"),function(_36,_37,_38){
with(_36){
var _39=objj_msgSend(_38,"locationInWindow"),_3a=objj_msgSend(_38,"type");
if(_3a==CPLeftMouseUp){
return;
}else{
if(_3a==CPLeftMouseDown){
_resizeFrame=CGRectMake(_39.x,_39.y,CGRectGetWidth(_frame),CGRectGetHeight(_frame));
}else{
if(_3a==CPLeftMouseDragged){
objj_msgSend(_36,"setFrameSize:",CGSizeMake(CGRectGetWidth(_resizeFrame)+_39.x-CGRectGetMinX(_resizeFrame),CGRectGetHeight(_resizeFrame)+_39.y-CGRectGetMinY(_resizeFrame)));
}
}
}
objj_msgSend(CPApp,"setTarget:selector:forNextEventMatchingMask:untilDate:inMode:dequeue:",_36,sel_getUid("trackResizeWithEvent:"),CPLeftMouseDraggedMask|CPLeftMouseUpMask,nil,nil,YES);
}
}),new objj_method(sel_getUid("orderFront:"),function(_3b,_3c,_3d){
with(_3b){
objj_msgSend(_bridge,"order:window:relativeTo:",CPWindowAbove,_3b,nil);
}
}),new objj_method(sel_getUid("orderBack:"),function(_3e,_3f,_40){
with(_3e){
}
}),new objj_method(sel_getUid("orderOut:"),function(_41,_42,_43){
with(_41){
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("windowWillClose:"))){
objj_msgSend(_delegate,"windowWillClose:",_41);
}
objj_msgSend(_bridge,"order:window:relativeTo:",CPWindowOut,_41,nil);
if(objj_msgSend(CPApp,"keyWindow")==_41){
objj_msgSend(_41,"resignKeyWindow");
CPApp._keyWindow=nil;
}
}
}),new objj_method(sel_getUid("orderWindow:relativeTo:"),function(_44,_45,_46,_47){
with(_44){
objj_msgSend(_bridge,"order:window:relativeTo:",_46,_44,CPApp._windows[_47]);
}
}),new objj_method(sel_getUid("setLevel:"),function(_48,_49,_4a){
with(_48){
_level=_4a;
}
}),new objj_method(sel_getUid("level"),function(_4b,_4c){
with(_4b){
return _level;
}
}),new objj_method(sel_getUid("isVisible"),function(_4d,_4e){
with(_4d){
return _isVisible;
}
}),new objj_method(sel_getUid("showsResizeIndicator"),function(_4f,_50){
with(_4f){
return objj_msgSend(_windowView,"showsResizeIndicator");
}
}),new objj_method(sel_getUid("setShowsResizeIndicator:"),function(_51,_52,_53){
with(_51){
objj_msgSend(_windowView,"setShowsResizeIndicator:",_53);
}
}),new objj_method(sel_getUid("resizeIndicatorOffset"),function(_54,_55){
with(_54){
return objj_msgSend(_windowView,"resizeIndicatorOffset");
}
}),new objj_method(sel_getUid("setResizeIndicatorOffset:"),function(_56,_57,_58){
with(_56){
objj_msgSend(_windowView,"setResizeIndicatorOffset:",_58);
}
}),new objj_method(sel_getUid("setContentView:"),function(_59,_5a,_5b){
with(_59){
if(_contentView){
objj_msgSend(_contentView,"removeFromSuperview");
}
_contentView=_5b;
objj_msgSend(_contentView,"setFrame:",objj_msgSend(_59,"contentRectForFrameRect:",_frame));
objj_msgSend(_contentView,"setAutoresizingMask:",CPViewWidthSizable|CPViewHeightSizable);
objj_msgSend(_windowView,"addSubview:positioned:relativeTo:",_contentView,CPWindowBelow,nil);
}
}),new objj_method(sel_getUid("contentView"),function(_5c,_5d){
with(_5c){
return _contentView;
}
}),new objj_method(sel_getUid("setBackgroundColor:"),function(_5e,_5f,_60){
with(_5e){
objj_msgSend(_windowView,"setBackgroundColor:",_60);
}
}),new objj_method(sel_getUid("backgroundColor"),function(_61,_62){
with(_61){
return objj_msgSend(_windowView,"backgroundColor");
}
}),new objj_method(sel_getUid("setMinSize:"),function(_63,_64,_65){
with(_63){
if(CGSizeEqualToSize(_minSize,_65)){
return;
}
_minSize=CGSizeCreateCopy(_65);
var _66=CGSizeMakeCopy(objj_msgSend(_63,"frame").size),_67=NO;
if(_66.width<_minSize.width){
_66.width=_minSize.width;
_67=YES;
}
if(_66.height<_minSize.height){
_66.height=_minSize.height;
_67=YES;
}
if(_67){
objj_msgSend(_63,"setFrameSize:",_66);
}
}
}),new objj_method(sel_getUid("minSize"),function(_68,_69){
with(_68){
return _minSize;
}
}),new objj_method(sel_getUid("setMaxSize:"),function(_6a,_6b,_6c){
with(_6a){
if(CGSizeEqualToSize(_maxSize,_6c)){
return;
}
_maxSize=CGSizeCreateCopy(_6c);
var _6d=CGSizeMakeCopy(objj_msgSend(_6a,"frame").size),_6e=NO;
if(_6d.width>_maxSize.width){
_6d.width=_maxSize.width;
_6e=YES;
}
if(_6d.height>_maxSize.height){
_6d.height=_maxSize.height;
_6e=YES;
}
if(_6e){
objj_msgSend(_6a,"setFrameSize:",_6d);
}
}
}),new objj_method(sel_getUid("maxSize"),function(_6f,_70){
with(_6f){
return _maxSize;
}
}),new objj_method(sel_getUid("hasShadow"),function(_71,_72){
with(_71){
return _hasShadow;
}
}),new objj_method(sel_getUid("setHasShadow:"),function(_73,_74,_75){
with(_73){
if(_hasShadow==_75){
return;
}
_hasShadow=_75;
if(_hasShadow){
var _76=objj_msgSend(_windowView,"bounds");
_shadowView=objj_msgSend(objj_msgSend(CPView,"alloc"),"initWithFrame:",CGRectMake(-_1,-_3+_5,_1+CGRectGetWidth(_76)+_2,_3+CGRectGetHeight(_76)+_4));
if(!_6){
var _77=objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(_73,"class"));
_6=objj_msgSend(CPColor,"colorWithPatternImage:",objj_msgSend(objj_msgSend(CPNinePartImage,"alloc"),"initWithImageSlices:",[objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_77,"pathForResource:","CPWindow/CPWindowShadow0.png"),CGSizeMake(20,19)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_77,"pathForResource:","CPWindow/CPWindowShadow1.png"),CGSizeMake(1,19)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_77,"pathForResource:","CPWindow/CPWindowShadow2.png"),CGSizeMake(19,19)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_77,"pathForResource:","CPWindow/CPWindowShadow3.png"),CGSizeMake(20,1)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_77,"pathForResource:","CPWindow/CPWindowShadow4.png"),CGSizeMake(1,1)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_77,"pathForResource:","CPWindow/CPWindowShadow5.png"),CGSizeMake(19,1)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_77,"pathForResource:","CPWindow/CPWindowShadow6.png"),CGSizeMake(20,18)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_77,"pathForResource:","CPWindow/CPWindowShadow7.png"),CGSizeMake(1,18)),objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_77,"pathForResource:","CPWindow/CPWindowShadow8.png"),CGSizeMake(19,18))]));
}
...
var _7b=objj_msgSend(CPNotificationCenter,"defaultCenter");
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("windowDidBecomeMain:"))){
objj_msgSend(_7b,"addObserver:selector:name:object:",_delegate,sel_getUid("windowDidBecomeMain:"),CPWindowDidBecomeMainNotification,_78);
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("windowDidResignMain:"))){
objj_msgSend(_7b,"addObserver:selector:name:object:",_delegate,sel_getUid("windowDidResignMain:"),CPWindowDidResignMainNotification,_78);
}
}
}),new objj_method(sel_getUid("delegate"),function(_7c,_7d){
with(_7c){
return _delegate;
}
}),new objj_method(sel_getUid("setWindowController:"),function(_7e,_7f,_80){
with(_7e){
_windowController=_80;
}
}),new objj_method(sel_getUid("windowController"),function(_81,_82){
with(_81){
return _windowController;
}
}),new objj_method(sel_getUid("doCommandBySelector:"),function(_83,_84,_85){
with(_83){
if(objj_msgSend(_delegate,"respondsToSelector:",_85)){
objj_msgSend(_delegate,"performSelector:",_85);
}else{
objj_msgSendSuper({receiver:_83,super_class:objj_getClass("CPResponder")},"doCommandBySelector:",_85);
}
}
}),new objj_method(sel_getUid("acceptsFirstResponder"),function(_86,_87){
with(_86){
return YES;
}
}),new objj_method(sel_getUid("makeFirstResponder:"),function(_88,_89,_8a){
with(_88){
if(_firstResponder==_8a){
return YES;
}
if(!objj_msgSend(_firstResponder,"resignFirstResponder")){
return NO;
}
if(!_8a||!objj_msgSend(_8a,"acceptsFirstResponder")||!objj_msgSend(_8a,"becomeFirstResponder")){
_firstResponder=_88;
return NO;
}
_firstResponder=_8a;
...
}),new objj_method(sel_getUid("firstResponder"),function(_8b,_8c){
with(_8b){
return _firstResponder;
}
}),new objj_method(sel_getUid("acceptsMouseMovedEvents"),function(_8d,_8e){
with(_8d){
return _acceptsMouseMovedEvents;
}
}),new objj_method(sel_getUid("setAcceptsMouseMovedEvents:"),function(_8f,_90,_91){
with(_8f){
_acceptsMouseMovedEvents=_91;
}
}),new objj_method(sel_getUid("title"),function(_92,_93){
with(_92){
return _title;
}
}),new objj_method(sel_getUid("setTitle:"),function(_94,_95,_96){
with(_94){
_title=_96;
objj_msgSend(_windowView,"setTitle:",_96);
objj_msgSend(_94,"_synchronizeMenuBarTitleWithWindowTitle");
}
}),new objj_method(sel_getUid("setTitleWithRepresentedFilename:"),function(_97,_98,_99){
with(_97){
objj_msgSend(_97,"setRepresentedFilename:",_99);
objj_msgSend(_97,"setTitle:",objj_msgSend(_99,"lastPathComponent"));
}
}),new objj_method(sel_getUid("setRepresentedFilename:"),function(_9a,_9b,_9c){
with(_9a){
objj_msgSend(_9a,"setRepresentedURL:",_9c);
}
}),new objj_method(sel_getUid("representedFilename"),function(_9d,_9e){
with(_9d){
return _representedURL;
}
}),new objj_method(sel_getUid("setRepresentedURL:"),function(_9f,_a0,_a1){
with(_9f){
_representedURL=_a1;
}
}),new objj_method(sel_getUid("representedURL"),function(_a2,_a3){
with(_a2){
return _representedURL;
}
}),new objj_method(sel_getUid("setMovableByWindowBackground:"),function(_a4,_a5,_a6){
with(_a4){
_isMovableByWindowBackground=_a6;
}
}),new objj_method(sel_getUid("isMovableByWindowBackground"),function(_a7,_a8){
with(_a7){
return _isMovableByWindowBackground;
}
}),new objj_method(sel_getUid("center"),function(_a9,_aa){
with(_a9){
var _ab=objj_msgSend(_a9,"frame").size,_ac=objj_msgSend(_bridge,"contentBounds").size;
objj_msgSend(_a9,"setFrameOrigin:",CGPointMake((_ac.width-_ab.width)/2,(_ac.height-_ab.height)/2));
}
}),new objj_method(sel_getUid("sendEvent:"),function(_ad,_ae,_af){
with(_ad){
var _b0=objj_msgSend(_af,"type"),_b1=objj_msgSend(_af,"locationInWindow");
switch(_b0){
case CPKeyUp:
return objj_msgSend(objj_msgSend(_ad,"firstResponder"),"keyUp:",_af);
case CPKeyDown:
return objj_msgSend(objj_msgSend(_ad,"firstResponder"),"keyDown:",_af);
case CPScrollWheel:
return objj_msgSend(objj_msgSend(_windowView,"hitTest:",_b1),"scrollWheel:",_af);
case CPLeftMouseUp:
if(!_leftMouseDownView){
return objj_msgSend(objj_msgSend(_windowView,"hitTest:",_b1),"mouseUp:",_af);
}
objj_msgSend(_leftMouseDownView,"mouseUp:",_af);
_leftMouseDownView=nil;
return;
case CPLeftMouseDown:
_leftMouseDownView=objj_msgSend(_windowView,"hitTest:",_b1);
if(_leftMouseDownView!=_firstResponder&&objj_msgSend(_leftMouseDownView,"acceptsFirstResponder")){
objj_msgSend(_ad,"makeFirstResponder:",_leftMouseDownView);
}
var _b2=objj_msgSend(_af,"window");
if(objj_msgSend(_b2,"isKeyWindow")||objj_msgSend(_b2,"becomesKeyOnlyIfNeeded")){
return objj_msgSend(_leftMouseDownView,"mouseDown:",_af);
}else{
objj_msgSend(_ad,"makeKeyAndOrderFront:",_ad);
if(objj_msgSend(_leftMouseDownView,"acceptsFirstMouse:",_af)){
return objj_msgSend(_leftMouseDownView,"mouseDown:",_af);
}
}
break;
...
if(!_leftMouseDownView){
return objj_msgSend(objj_msgSend(_windowView,"hitTest:",_b1),"mouseDragged:",_af);
}
return objj_msgSend(_leftMouseDownView,"mouseDragged:",_af);
case CPRightMouseUp:
return objj_msgSend(_rightMouseDownView,"mouseUp:",_af);
case CPRightMouseDown:
_rightMouseDownView=objj_msgSend(_windowView,"hitTest:",_b1);
return objj_msgSend(_rightMouseDownView,"mouseDown:",_af);
case CPRightMouseDragged:
return objj_msgSend(_rightMouseDownView,"mouseDragged:",_af);
case CPMouseMoved:
if(!_acceptsMouseMovedEvents){
return;
}
var _b3=objj_msgSend(_windowView,"hitTest:",_b1);
if(_b3!=_mouseOverView){
if(_mouseOverView){
objj_msgSend(_mouseOverView,"mouseExited:",objj_msgSend(CPEvent,"mouseEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:clickCount:pressure:",CPMouseExited,_b1,objj_msgSend(_af,"modifierFlags"),objj_msgSend(_af,"timestamp"),_windowNumber,nil,-1,1,0));
}
if(_b3){
objj_msgSend(_b3,"mouseEntered:",objj_msgSend(CPEvent,"mouseEventWithType:location:modifierFlags:timestamp:windowNumber:context:eventNumber:clickCount:pressure:",CPMouseEntered,_b1,objj_msgSend(_af,"modifierFlags"),objj_msgSend(_af,"timestamp"),_windowNumber,nil,-1,1,0));
}
_mouseOverView=_b3;
}
objj_msgSend(_mouseOverView,"mouseMoved:",_af);
}
}
}),new objj_method(sel_getUid("windowNumber"),function(_b4,_b5){
with(_b4){
return _windowNumber;
}
}),new objj_method(sel_getUid("becomeKeyWindow"),function(_b6,_b7){
with(_b6){
if(_firstResponder!=_b6&&objj_msgSend(_firstResponder,"respondsToSelector:",sel_getUid("becomeKeyWindow"))){
objj_msgSend(_firstResponder,"becomeKeyWindow");
}
}
}),new objj_method(sel_getUid("canBecomeKeyWindow"),function(_b8,_b9){
with(_b8){
return YES;
}
}),new objj_method(sel_getUid("isKeyWindow"),function(_ba,_bb){
with(_ba){
return objj_msgSend(CPApp,"keyWindow")==_ba;
}
}),new objj_method(sel_getUid("makeKeyAndOrderFront:"),function(_bc,_bd,_be){
with(_bc){
objj_msgSend(_bc,"orderFront:",_bc);
objj_msgSend(_bc,"makeKeyWindow");
objj_msgSend(_bc,"makeMainWindow");
}
}),new objj_method(sel_getUid("makeKeyWindow"),function(_bf,_c0){
with(_bf){
if(!objj_msgSend(_bf,"canBecomeKeyWindow")){
return;
}
objj_msgSend(CPApp._keyWindow,"resignKeyWindow");
CPApp._keyWindow=_bf;
objj_msgSend(_bf,"becomeKeyWindow");
}
}),new objj_method(sel_getUid("resignKeyWindow"),function(_c1,_c2){
with(_c1){
if(_firstResponder!=_c1&&objj_msgSend(_firstResponder,"respondsToSelector:",sel_getUid("resignKeyWindow"))){
objj_msgSend(_firstResponder,"resignKeyWindow");
}
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("windowDidResignKey:"))){
objj_msgSend(_delegate,"windowDidResignKey:",_c1);
}
}
}),new objj_method(sel_getUid("dragImage:at:offset:event:pasteboard:source:slideBack:"),function(_c3,_c4,_c5,_c6,_c7,_c8,_c9,_ca,_cb){
with(_c3){
objj_msgSend(objj_msgSend(CPDragServer,"sharedDragServer"),"dragImage:fromWindow:at:offset:event:pasteboard:source:slideBack:",_c5,_c3,objj_msgSend(_c3,"convertBaseToBridge:",_c6),_c7,_c8,_c9,_ca,_cb);
}
}),new objj_method(sel_getUid("dragView:at:offset:event:pasteboard:source:slideBack:"),function(_cc,_cd,_ce,_cf,_d0,_d1,_d2,_d3,_d4){
with(_cc){
objj_msgSend(objj_msgSend(CPDragServer,"sharedDragServer"),"dragView:fromWindow:at:offset:event:pasteboard:source:slideBack:",_ce,_cc,objj_msgSend(_cc,"convertBaseToBridge:",_cf),_d0,_d1,_d2,_d3,_d4);
}
}),new objj_method(sel_getUid("setDocumentEdited:"),function(_d5,_d6,_d7){
with(_d5){
if(_isDocumentEdited==_d7){
return;
}
_isDocumentEdited=_d7;
objj_msgSend(CPMenu,"_setMenuBarIconImageAlphaValue:",_isDocumentEdited?0.5:1);
}
}),new objj_method(sel_getUid("isDocumentEdited"),function(_d8,_d9){
with(_d8){
return _isDocumentEdited;
}
}),new objj_method(sel_getUid("setDocumentSaving:"),function(_da,_db,_dc){
with(_da){
if(_isDocumentSaving==_dc){
return;
}
_isDocumentSaving=_dc;
objj_msgSend(_da,"_synchronizeSaveMenuWithDocumentSaving");
objj_msgSend(_windowView,"windowDidChangeDocumentSaving");
}
}),new objj_method(sel_getUid("isDocumentSaving"),function(_dd,_de){
with(_dd){
return _isDocumentSaving;
}
}),new objj_method(sel_getUid("_synchronizeSaveMenuWithDocumentSaving"),function(_df,_e0){
with(_df){
if(!objj_msgSend(_df,"isMainWindow")){
return;
}
var _e1=objj_msgSend(CPApp,"mainMenu"),_e2=objj_msgSend(_e1,"indexOfItemWithTitle:",_isDocumentSaving?"Save":"Saving...");
if(_e2==CPNotFound){
return;
}
var _e3=objj_msgSend(_e1,"itemAtIndex:",_e2);
if(_isDocumentSaving){
_7=objj_msgSend(_e3,"image");
objj_msgSend(_e3,"setTitle:","Saving...");
objj_msgSend(_e3,"setImage:",_8);
objj_msgSend(_e3,"setEnabled:",NO);
}else{
objj_msgSend(_e3,"setTitle:","Save");
objj_msgSend(_e3,"setImage:",_7);
objj_msgSend(_e3,"setEnabled:",YES);
}
}
}),new objj_method(sel_getUid("performClose:"),function(_e4,_e5,_e6){
with(_e4){
if(objj_msgSend(_delegate,"respondsToSelector:",sel_getUid("windowShouldClose:"))){
if(!objj_msgSend(_delegate,"windowShouldClose:",_e4)){
return;
}
}else{
if(objj_msgSend(_e4,"respondsToSelector:",sel_getUid("windowShouldClose:"))&&!objj_msgSend(_e4,"windowShouldClose:",_e4)){
return;
}
}
objj_msgSend(_e4,"close");
}
}),new objj_method(sel_getUid("close"),function(_e7,_e8){
with(_e7){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:",CPWindowWillCloseNotification,_e7);
objj_msgSend(_e7,"orderOut:",nil);
}
}),new objj_method(sel_getUid("isMainWindow"),function(_e9,_ea){
with(_e9){
return objj_msgSend(CPApp,"mainWindow")==_e9;
}
}),new objj_method(sel_getUid("canBecomeMainWindow"),function(_eb,_ec){
with(_eb){
if(objj_msgSend(_eb,"isVisible")){
return YES;
}
return NO;
}
}),new objj_method(sel_getUid("makeMainWindow"),function(_ed,_ee){
with(_ed){
if(!objj_msgSend(_ed,"canBecomeMainWindow")){
return;
}
objj_msgSend(CPApp._mainWindow,"resignMainWindow");
CPApp._mainWindow=_ed;
objj_msgSend(_ed,"becomeMainWindow");
}
}),new objj_method(sel_getUid("becomeMainWindow"),function(_ef,_f0){
with(_ef){
objj_msgSend(_ef,"_synchronizeMenuBarTitleWithWindowTitle");
objj_msgSend(_ef,"_synchronizeSaveMenuWithDocumentSaving");
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:",CPWindowDidBecomeMainNotification,_ef);
}
}),new objj_method(sel_getUid("resignMainWindow"),function(_f1,_f2){
with(_f1){
objj_msgSend(objj_msgSend(CPNotificationCenter,"defaultCenter"),"postNotificationName:object:",CPWindowDidResignMainNotification,_f1);
}
}),new objj_method(sel_getUid("toolbar"),function(_f3,_f4){
with(_f3){
return _toolbar;
}
}),new objj_method(sel_getUid("setToolbar:"),function(_f5,_f6,_f7){
with(_f5){
if(_toolbar==_f7){
return;
}
if(_toolbar){
objj_msgSend(_f5,"_setToolbarVisible:",NO);
_toolbar._window=nil;
_toolbarView=nil;
}
if(_toolbar=_f7){
_toolbar=_f7;
_toolbar._window=_f5;
if(objj_msgSend(_toolbar,"isVisible")){
objj_msgSend(_f5,"_setToolbarVisible:",YES);
}
objj_msgSend(_toolbar,"_reloadToolbarItems");
}
}
}),new objj_method(sel_getUid("_setToolbarVisible:"),function(_f8,_f9,_fa){
with(_f8){
if(_fa){
if(!_toolbarView){
...
objj_msgSend(_contentView,"setFrame:",objj_msgSend(_f8,"contentRectForFrameRect:",objj_msgSend(_windowView,"bounds")));
}
}),new objj_method(sel_getUid("_setAttachedSheetFrameOrigin"),function(_fb,_fc){
with(_fb){
var _fd=objj_msgSend(objj_msgSend(_fb,"contentView"),"frame"),_fe=CGRectMakeCopy(objj_msgSend(_attachedSheet,"frame"));
_fe.origin.y=CGRectGetMinY(_frame)+CGRectGetMinY(_fd);
_fe.origin.x=CGRectGetMinX(_frame)+FLOOR((CGRectGetWidth(_frame)-CGRectGetWidth(_fe))/2);
objj_msgSend(_attachedSheet,"setFrameOrigin:",_fe.origin);
}
}),new objj_method(sel_getUid("_animateAttachedSheet"),function(_ff,_cmd){
with(_ff){
}
}),new objj_method(sel_getUid("_attachSheet:modalDelegate:didEndSelector:contextInfo:"),function(self,_cmd,_103,_104,_105,_106){
with(self){
_attachedSheet=_103;
_103._isSheet=YES;
objj_msgSend(self,"_setAttachedSheetFrameOrigin");
objj_msgSend(_bridge,"order:window:relativeTo:",CPWindowAbove,_103,self);
}
...
var _111=objj_msgSend(CPBundle,"bundleForClass:",objj_msgSend(CPWindow,"class"));
CPWindowResizeIndicatorImage=objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_111,"pathForResource:","CPWindowResizeIndicator.png"),CGSizeMake(12,12));
_8=objj_msgSend(objj_msgSend(CPImage,"alloc"),"initWithContentsOfFile:size:",objj_msgSend(_111,"pathForResource:","CPProgressIndicator/CPProgressIndicatorSpinningStyleRegular.gif"),CGSizeMake(16,16));
}
}),new objj_method(sel_getUid("frameRectForContentRect:styleMask:"),function(self,_cmd,_114,_115){
with(self){
var _116=CGRectMakeCopy(_114);
return _116;
}
})]);
...
var _a=_9.isa;
class_addMethods(_9,[new objj_method(sel_getUid("setBridge:"),function(self,_cmd,_11b){
with(self){
if(_bridge==_11b){
return;
}
...
_bridge=_11b;
if(_styleMask&CPBorderlessBridgeWindowMask){
objj_msgSend(self,"setFrame:",objj_msgSend(_11b,"contentBounds"));
}
}
}),new objj_method(sel_getUid("resizeWithOldBridgeSize:"),function(self,_cmd,_11e){
with(self){
if(_styleMask&CPBorderlessBridgeWindowMask){
...
var _11f=objj_msgSend(_bridge,"contentBounds"),_120=CGRectMakeCopy(_frame),dX=(CGRectGetWidth(_11f)-_11e.width)/(((_autoresizingMask&CPWindowMinXMargin)?1:0)+(_autoresizingMask&CPWindowWidthSizable?1:0)+(_autoresizingMask&CPWindowMaxXMargin?1:0)),dY=(CGRectGetHeight(_11f)-_11e.height)/((_autoresizingMask&CPWindowMinYMargin?1:0)+(_autoresizingMask&CPWindowHeightSizable?1:0)+(_autoresizingMask&CPWindowMaxYMargin?1:0));
...
objj_msgSend(self,"setFrame:",_120);
}
}),new objj_method(sel_getUid("setAutoresizingMask:"),function(self,_cmd,_125){
with(self){
_autoresizingMask=_125;
}
}),new objj_method(sel_getUid("autoresizingMask"),function(self,_cmd){
with(self){
return _autoresizingMask;
}
}),new objj_method(sel_getUid("convertBaseToBridge:"),function(self,_cmd,_12a){
with(self){
var _12b=objj_msgSend(self,"frame").origin;
return CGPointMake(_12a.x+_12b.x,_12a.y+_12b.y);
}
}),new objj_method(sel_getUid("convertBridgeToBase:"),function(self,_cmd,_12e){
with(self){
var _12f=objj_msgSend(self,"frame").origin;
return CGPointMake(_12e.x-_12f.x,_12e.y-_12f.y);
}
...
}),new objj_method(sel_getUid("undo:"),function(self,_cmd,_134){
with(self){
objj_msgSend(objj_msgSend(self,"undoManager"),"undo");
}
}),new objj_method(sel_getUid("redo:"),function(self,_cmd,_137){
with(self){
objj_msgSend(objj_msgSend(self,"undoManager"),"redo");
}
})]);
var _138=function(_139,_13a,_13b){
return _139+(_13a-_139)*_13b;
};
...
objj_registerClassPair(_9);
objj_addClassForBundle(_9,objj_getBundleWithPath(OBJJ_CURRENT_BUNDLE.path));
class_addMethods(_9,[new objj_method(sel_getUid("initWithWindow:targetFrame:"),function(self,_cmd,_13e,_13f){
with(self){
...
if(self){
_window=_13e;
_targetFrame=CGRectMakeCopy(_13f);
...
}),new objj_method(sel_getUid("setCurrentProgress:"),function(self,_cmd,_144){
with(self){
objj_msgSendSuper({receiver:self,super_class:objj_getClass("CPAnimation")},"setCurrentProgress:",_144);
var _145=objj_msgSend(self,"currentValue");
if(_145==1){
_window._isAnimating=NO;
}
objj_msgSend(_window,"setFrameOrigin:",CGPointMake(_138(CGRectGetMinX(_startFrame),CGRectGetMinX(_targetFrame),_145),_138(CGRectGetMinY(_startFrame),CGRectGetMinY(_targetFrame),_145)));
objj_msgSend(_window,"setFrameSize:",CGSizeMake(_138(CGRectGetWidth(_startFrame),CGRectGetWidth(_targetFrame),_145),_138(CGRectGetHeight(_startFrame),CGRectGetHeight(_targetFrame),_145)));
}
})]);
