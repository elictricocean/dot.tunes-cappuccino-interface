...
p;14;CPDictionary.ji;10;CPObject.ji;14;CPEnumerator.ji;13;CPException.jc;5476;
...
}),new objj_method(sel_getUid("removeObjectsForKeys:"),function(_30,_31,_32){
with(_30){
for(var i=0,_34=_32.length;i<_34;i++){
dictionary_removeValue(_30,_32[i]);
}
}
}),new objj_method(sel_getUid("setObject:forKey:"),function(_35,_36,_37,_38){
with(_35){
dictionary_setValue(_35,_38,_37);
}
}),new objj_method(sel_getUid("addEntriesFromDictionary:"),function(_39,_3a,_3b){
with(_39){
if(!_3b){
return;
}
var _3c=objj_msgSend(_3b,"allKeys");
for(var i=0,_3e=objj_msgSend(_3c,"count");i<_3e;i++){
var _3f=_3c[i];
objj_msgSend(_39,"setObject:forKey:",objj_msgSend(_3b,"objectForKey:",_3f),_3f);
}
}
}),new objj_method(sel_getUid("description"),function(_40,_41){
with(_40){
var _42="CPDictionary {\n";
var i=_keys.length;
while(i--){
_42+=_keys[i]+":"+objj_msgSend(_buckets[_keys[i]],"description")+"\n";
}
_42+="}";
return _42;
}
})]);
class_addMethods(_2,[new objj_method(sel_getUid("alloc"),function(_44,_45){
with(_44){
return new objj_dictionary();
}
}),new objj_method(sel_getUid("dictionary"),function(_46,_47){
with(_46){
return objj_msgSend(objj_msgSend(_46,"alloc"),"init");
}
}),new objj_method(sel_getUid("dictionaryWithDictionary:"),function(_48,_49,_4a){
with(_48){
return objj_msgSend(objj_msgSend(_48,"alloc"),"initWithDictionary:",_4a);
}
}),new objj_method(sel_getUid("dictionaryWithObject:forKey:"),function(_4b,_4c,_4d,_4e){
with(_4b){
return objj_msgSend(objj_msgSend(_4b,"alloc"),"initWithObjects:forKeys:",[_4d],[_4e]);
}
}),new objj_method(sel_getUid("dictionaryWithObjects:forKeys:"),function(_4f,_50,_51,_52){
with(_4f){
return objj_msgSend(objj_msgSend(_4f,"alloc"),"initWithObjects:forKeys:",_51,_52);
}
})]);
...
with(_53){
return objj_msgSend(_55,"_decodeDictionaryOfObjectsForKey:","CP.objects");
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_56,_57,_58){
with(_56){
objj_msgSend(_58,"_encodeDictionaryOfObjects:forKey:",_56,"CP.objects");
}
})]);
...
p;7;CPSet.ji;10;CPObject.ji;9;CPArray.ji;10;CPNumber.jc;6166;
...
objj_msgSend(_5,"addObject:",_7[i]);
}
}
return _5;
}
...
}),new objj_method(sel_getUid("initWithSet:"),function(_12,_13,set){
with(_12){
return objj_msgSend(set,"copy");
}
}),new objj_method(sel_getUid("initWithSet:copyItems:"),function(_15,_16,set,_18){
with(_15){
return objj_msgSend(_15,"initWithSet:",set);
}
}),new objj_method(sel_getUid("allObjects"),function(_19,_1a){
with(_19){
var _1b=[];
for(var _1c in _contents){
if(_contents.hasOwnProperty(_1c)){
_1b.push(_contents[_1c]);
}
}
return _1b;
}
}),new objj_method(sel_getUid("anyObject"),function(_1d,_1e){
with(_1d){
for(var _1f in _contents){
if(_contents.hasOwnProperty(_1f)){
return _contents[_1f];
}
}
return nil;
}
}),new objj_method(sel_getUid("containsObject:"),function(_20,_21,_22){
with(_20){
if(_contents[objj_msgSend(_22,"hash")]&&objj_msgSend(_contents[objj_msgSend(_22,"hash")],"isEqual:",_22)){
return YES;
}
return NO;
}
}),new objj_method(sel_getUid("count"),function(_23,_24){
with(_23){
return _count;
}
}),new objj_method(sel_getUid("intersectsSet:"),function(_25,_26,set){
with(_25){
var _28=objj_msgSend(set,"allObjects");
for(var i=_28.length;i>0;i--){
if(objj_msgSend(_25,"containsObject:",_28[i])){
return YES;
}
}
return NO;
}
}),new objj_method(sel_getUid("isEqualToSet:"),function(_2a,_2b,set){
with(_2a){
return _2a===set||(objj_msgSend(_2a,"count")===objj_msgSend(set,"count")&&objj_msgSend(set,"isSubsetOfSet:",_2a));
}
}),new objj_method(sel_getUid("isSubsetOfSet:"),function(_2d,_2e,set){
with(_2d){
var _30=objj_msgSend(_2d,"allObjects");
for(var i=0;i<_30.length;i++){
if(!objj_msgSend(set,"containsObject:",_30[i])){
return NO;
}
}
return YES;
}
}),new objj_method(sel_getUid("makeObjectsPerformSelector:"),function(_32,_33,_34){
with(_32){
objj_msgSend(_32,"makeObjectsPerformSelector:withObject:",_34,nil);
}
}),new objj_method(sel_getUid("makeObjectsPerformSelector:withObject:"),function(_35,_36,_37,_38){
with(_35){
var _39=objj_msgSend(_35,"allObjects");
for(var i=0;i<_39.length;i++){
objj_msgSend(_39[i],"performSelector:withObject:",_37,_38);
}
}
}),new objj_method(sel_getUid("member:"),function(_3b,_3c,_3d){
with(_3b){
if(objj_msgSend(_3b,"containsObject:",_3d)){
return _3d;
}
return nil;
}
}),new objj_method(sel_getUid("initWithCapacity:"),function(_3e,_3f,_40){
with(_3e){
_3e=objj_msgSend(_3e,"init");
return _3e;
}
}),new objj_method(sel_getUid("setSet:"),function(_41,_42,set){
with(_41){
objj_msgSend(_41,"removeAllObjects");
objj_msgSend(_41,"addObjectsFromArray:",objj_msgSend(set,"allObjects"));
}
}),new objj_method(sel_getUid("addObject:"),function(_44,_45,_46){
with(_44){
_contents[objj_msgSend(_46,"hash")]=_46;
_count++;
}
}),new objj_method(sel_getUid("addObjectsFromArray:"),function(_47,_48,_49){
with(_47){
for(var i=0,_4b=_49.length;i<_4b;i++){
objj_msgSend(_47,"addObject:",_49[i]);
}
}
}),new objj_method(sel_getUid("removeObject:"),function(_4c,_4d,_4e){
with(_4c){
if(objj_msgSend(_4c,"containsObject:",_4e)){
delete _contents[objj_msgSend(_4e,"hash")];
_count--;
}
}
...
}),new objj_method(sel_getUid("intersectSet:"),function(_51,_52,set){
with(_51){
var _54=objj_msgSend(_51,"allObjects");
for(var i=0,_56=_54.length;i<_56;i++){
if(!objj_msgSend(set,"containsObject:",_54[i])){
objj_msgSend(_51,"removeObject:",_54[i]);
}
}
}
}),new objj_method(sel_getUid("minusSet:"),function(_57,_58,set){
with(_57){
var _5a=objj_msgSend(set,"allObjects");
for(var i=0;i<_5a.length;i++){
if(objj_msgSend(_57,"containsObject:",_5a[i])){
objj_msgSend(_57,"removeObject:",_5a[i]);
}
}
}
}),new objj_method(sel_getUid("unionSet:"),function(_5c,_5d,set){
with(_5c){
var _5f=objj_msgSend(set,"allObjects");
for(var i=0,_61=_5f.length;i<_61;i++){
objj_msgSend(_5c,"addObject:",_5f[i]);
}
}
})]);
...
with(_6e){
var set=objj_msgSend(objj_msgSend(_6e,"alloc"),"init"),_72=arguments.length,i=2;
for(;i<_72&&(argument=arguments[i])!=nil;++i){
objj_msgSend(set,"addObject:",argument);
}
return set;
}
}),new objj_method(sel_getUid("setWithSet:"),function(_74,_75,set){
with(_74){
return objj_msgSend(objj_msgSend(_74,"alloc"),"initWithSet:",set);
}
}),new objj_method(sel_getUid("setWithCapacity:"),function(_77,_78,_79){
with(_77){
return objj_msgSend(objj_msgSend(_77,"alloc"),"initWithCapacity:",_79);
}
})]);
...
p;10;CPString.ji;10;CPObject.ji;13;CPException.ji;18;CPSortDescriptor.jc;8096;
